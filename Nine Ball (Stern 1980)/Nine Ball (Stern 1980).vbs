...
Const cGameName="nineball",UseSolenoids=2,UseLamps=0,UseGI=0,SSolenoidOn="Solenoid",SSolenoidOff="SolOff"
Const SCoin=""

LoadVPM "01110000", "Stern.VBS", 1.2
...
SolCallback(4)	= "Sol2DropUp"
SolCallback(6)	= "SolKnocker"
SolCallback(7)	= "bsTrough.SolOut"
SolCallback(8)	=  "bslsaucer.SolOut"
SolCallback(9)	=  "dt7drop"
SolCallback(10)	=  "dt6drop"
SolCallback(11)	=  "dt5drop"
SolCallback(12)	=  "dt4drop"
SolCallback(13)	=  "dt3drop"
SolCallback(14)	= "dt2drop"
SolCallback(15)	= "dt1drop"
SolCallback(17)	=  "SolBankDropUp"
SolCallback(19)	=  "vpmNudge.SolGameOn"
SolCallback(20)	= "Sol1DropUp"
...
Sub Sol1DropUp(enabled)
	if enabled then
		PlaySoundAt SoundFX(DTResetSound,DOFContactors), psw21
		DTRaise 21
	end if
End Sub
...
Sub Sol2DropUp(enabled)
	if enabled then
		PlaySoundAt SoundFX(DTResetSound,DOFContactors), psw19
		DTRaise 18
		DTRaise 19
		DTRaise 20
	end if
...
Sub SolBankDropUp(enabled)
	if enabled then
		PlaySoundAt SoundFX(DTResetSound,DOFContactors), psw12
		DTRaise 9
		DTRaise 10
		DTRaise 11
		DTRaise 12
...
End Sub
    ...
    With bslSaucer
        .InitSaucer sw34,34,180,12
        .KickAngleVar = 2
        .KickForceVar = 3
		randomsoundballrelease sw34
    End With
...
Sub sw34_Hit:RandomSoundDrain sw34:bslSaucer.AddBall 0:End Sub
...
Sub Sw13_Hit:DTHit 13:End Sub
Sub Sw14_Hit:DTHit 14:End Sub
...
'Stand Up Targets
 Sub Tsw35_Hit: PrimStandupTgtHit 12, Tsw35, PrimT35: vpmTimer.PulseSw 35 : End Sub
 Sub Tsw35_Timer: PrimStandupTgtMove 12, Tsw35, PrimT35: End Sub
...
End Function
 ...
 'Wire Triggers
 Sub sw25_Hit  : Controller.Switch(25) = 1 : wire4.transz=-6:End Sub
 Sub sw25_UnHit: Controller.Switch(25) = 0 : wire4.transz=0:End Sub
 Sub sw26_Hit  : Controller.Switch(26) = 1 : wire1.transz=-6:End Sub
 Sub sw26_UnHit: Controller.Switch(26) = 0 : wire1.transz=0:End Sub
 Sub sw27_Hit  : Controller.Switch(27) = 1 : wire3.transz=-6:End Sub
 Sub sw27_UnHit: Controller.Switch(27) = 0 : wire3.transz=0:End Sub
 Sub sw28_Hit  : Controller.Switch(28) = 1 : wire2.transz=-6:End Sub
 Sub sw28_UnHit: Controller.Switch(28) = 0 : wire2.transz=0:End Sub
 Sub sw32_Hit  : Controller.Switch(32) = 1 : wire5.transz=-6:End Sub
 Sub sw32_UnHit: Controller.Switch(32) = 0 : wire5.transz=0:End Sub
 Sub sw38_Hit  : Controller.Switch(38) = 1 : wire6.transz=-6:End Sub
 Sub sw38_UnHit: Controller.Switch(38) = 0 : wire6.transz=0:End Sub
 Sub sw39_Hit  : Controller.Switch(39) = 1 : wire7.transz=-6:End Sub
 Sub sw39_UnHit: Controller.Switch(39) = 0 : wire7.transz=0:End Sub
...
NFadeLm 29, L29a
NFadeLm 30, L30
NFadeObj 30, bumper2mesh, "UV2","UV2unlit"
NFadeObj 30, layer1skirt2, "UV2","UV2unlit"
NFadeLm 31, L31
NFadeLm 33, L33
NFadeLm 34, L34
NFadeLm 35, L35
...
Dim DTArray
DTArray = Array(DT9, DT10, DT11, DT12, DT13, DT14, DT15, DT16, DT18, DT19, DT20, DT21, DT22, DT23, DT24)
...
' Credits
VRDigits(28) = Array(LEDdx3,LEDdx7,LEDdx6,LEDdx2,LEDdx4,LEDdx5,LEDdx1)
VRDigits(29) = Array(LEDdx10,LEDdx14,LEDdx13,LEDdx9,LEDdx11,LEDdx12,LEDdx8)

' Balls
VRDigits(30) = Array(LEDdx17,LEDdx21,LEDdx20,LEDdx16,LEDdx18,LEDdx19,LEDdx15)
VRDigits(31) = Array(LEDdx24,LEDdx28,LEDdx27,LEDdx23,LEDdx25,LEDdx26,LEDdx22)
...
Sub UpdateMultipleLamps()
	If Controller.Lamp(13) = 0 Then: FlBGL13.visible=0:	else FlBGL13.visible=1 'High Score to Date
	If Controller.Lamp(63) = 0 Then: FlBGL63.visible=0:	else FlBGL63.visible=1 'Match
	If Controller.Lamp(62) = 0 Then: FlBGL62.visible=0:	else FlBGL62.visible=1 'Ball In Play
	If Controller.Lamp(45) = 0 Then: FlBGL45.visible=0: else FlBGL45.visible=1 'Game Over
	If Controller.Lamp(61) = 0 Then
		FlBGL61.visible=0
		VR_Backbox_Backglass.blenddisablelighting = 2
		FlBGLque.opacity = 200
		FlBGLnineball.opacity = 200
		FlBGLnineball1.opacity = 200
	else
		FlBGL61.visible=1 'Tilt
		VR_Backbox_Backglass.blenddisablelighting = 0.5
		FlBGLque.opacity = 0
		FlBGLnineball.opacity = 0
		FlBGLnineball1.opacity = 0
	End If

	If Controller.Lamp(57) = 0 Then: FlBGL57.visible=0: else FlBGL57.visible=1 '5 ball
	If Controller.Lamp(26) = 0 Then: FlBGL26.visible=0: else FlBGL26.visible=1 '3 ball
	If Controller.Lamp(25) = 0 Then: FlBGL25.visible=0: else FlBGL25.visible=1 '7 ball
	If Controller.Lamp(9)  = 0 Then: FlBGL9.visible=0:  else FlBGL9.visible=1  '8 ball
	If Controller.Lamp(42) = 0 Then: FlBGL42.visible=0: else FlBGL42.visible=1 '2 ball
	If Controller.Lamp(10) = 0 Then: FlBGL10.visible=0: else FlBGL10.visible=1 '4 ball
	If Controller.Lamp(41) = 0 Then: FlBGL41.visible=0: else FlBGL41.visible=1 '6 ball
	If Controller.Lamp(58) = 0 Then: FlBGL58.visible=0: else FlBGL58.visible=1 '1 ball
	If Controller.Lamp(5)  = 0 Then
		FlBGL5.visible=0
		FlBGL5a.visible=0
		FlBGL5b.visible=0
		FlBGL5c.visible=0
		...
		FlBGL5.visible=1 '9 ball
		FlBGL5a.visible=1 'wizard face
		FlBGL5b.visible=1
		FlBGL5c.visible=1
		FlBGL5d.visible=1
		FlBGL5e.visible=1
...
Sub UpdateDTLamps()
	If Controller.Lamp(13) = 0 Then: L13.state = 0:	Else: L13.state = 1 'High Score
	If Controller.Lamp(45) = 0 Then: L45.state = 0:	Else: L45.state = 1 'Game Over
	If Controller.Lamp(61) = 0 Then: L61.state = 0:	Else: L61.state = 1 'Tilt
	If Controller.Lamp(63) = 0 Then: L63.state = 0:	Else: L63.state = 1 'Match
End Sub
