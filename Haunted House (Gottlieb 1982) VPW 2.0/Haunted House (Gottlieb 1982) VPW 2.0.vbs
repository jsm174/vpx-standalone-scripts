...
Sub sw31_timer()
	Select Case sw31step
		...
		Case 1:
		Case 2:
		Case 3:	SoundSaucerKick 1,sw31
		'Case 4: sw31.Kickxyz 0,60,1.50,-7,-1,30
		Case 4: sw31.Kickxyz 20*(Rnd()-0.5),50 + (Rnd()*5),1.50,-7,-1,20
		Case 5:	
		Case 6:
		Case 7:
		Case 8:
...
Sub sw41_timer()
	Select Case sw41step
		...
		Case 1:
		Case 2:
		Case 3: SoundSaucerKick 1,sw41
		Case 4: sw41.Kickz 90,15,0.7,25
		Case 5:	
		Case 6:
		Case 7:
		Case 8:
...
Sub UpdateMods
	...
	' Room Brightness
	If RenderingMode = 2 Then SetRoomBrightness LightLevel/100
