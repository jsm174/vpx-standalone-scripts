...
Sub pfMini3_hit:light20.state=1:light43.state=1:End Sub
Sub pfMini3_unhit:light20.state=0:light43.state=0:End Sub
'******************************************************
'***************  Ramps Switches **********************
'******************************************************
...
wall3.blenddisablelighting=0.6
Clock_Top.blenddisablelighting=0.05
	Else Stopsound "fx_motor"
wall3.blenddisablelighting=0
Clock_Top.blenddisablelighting=0
    End If
End Sub
...
Sub UpdateLamps
    ...
    NFadeLm 61, l61a
    NFadeL 61, l61b
if l61.state=1 then bulb003.blenddisablelighting=2 
if l61.state=0 then bulb003.blenddisablelighting=0 
    NFadeLm 62, l62
    NFadeLm 62, l62a
    NFadeL 62, l62b
    NFadeLm 63, l63
    ...
    NFadeLm 81, l81
    Flash 81, l81a
    NFadeLm 82, l82 	'Clock Toy Mod lights
    Flash 82, l82r   	'Clock Toy Mod lights
    NFadeLm 83, l83
    NFadeL 83, l83a
if l83a.state=1 then bulb2.blenddisablelighting=15 
if l83a.state=0 then bulb2.blenddisablelighting=0 
    NFadeLm 84, l84
    NFadeL 84, l84a
if l84a.state=1 then bulb1.blenddisablelighting=5 
if l84a.state=0 then bulb1.blenddisablelighting=0 
    NFadeLm 85, l85
	...
	NFadeL 117, f17a
	NFadeLm 118, f18
if f18.state=1 then Prim_F2.blenddisablelighting=10 
if f18.state=0 then Prim_F2.blenddisablelighting=0 
	NFadeLm 118, f18a
	NFadeLm 118, f18b
	NFadeLm 118, f18c
	NFadeLm 118, f18d
	...
	NFadeLm 120, f20a
	NFadeLm 120, f20b
if f20b.state=1 then Prim_F1.blenddisablelighting=10 
if f20b.state=0 then Prim_F1.blenddisablelighting=0 
	NFadeLm 120, f20c
	NFadeLm 120, f20d
	Flashm 120, f20e
	Flash 120, f20r
	NFadeLm 128, f28
if f28.state=1 then Prim_F6.blenddisablelighting=2 
if f28.state=0 then Prim_F6.blenddisablelighting=0 
	NFadeLm 128, f28a
	NFadeLm 128, f28b
	Flashm 128, f28c
	Flash 128, f28r
	...
	NFadeLm 138, f38
if f38.state=1 then Prim_F5.blenddisablelighting=2 
if f38.state=0 then Prim_F5.blenddisablelighting=0 
	NFadeLm 138, f38a
	Flashm 138, f38b
	Flash 138, f38r
	NFadeLm 139, f39
if f39.state=1 then Prim_F3.blenddisablelighting=10 
if f39.state=0 then Prim_F3.blenddisablelighting=0 
	NFadeLm 139, f39a
	Flashm 139, f39b
	Flash 139, f39r
	NFadeLm 140, f40
if f40.state=1 then Prim_F4.blenddisablelighting=10 
if f40.state=0 then Prim_F4.blenddisablelighting=0 
	NFadeLm 140, f40a
	Flashm 140, f40b
	Flash 140, f40r
	NFadeLm 141, f41
	NFadeLm 141, f41a
if f41a.state=1 then Prim_F7.blenddisablelighting=10 
if f41a.state=0 then Prim_F7.blenddisablelighting=0 
	NFadeLm 141, f41b
	NFadeLm 141, f41c
	NFadeLm 141, f41d
	Flashm 141, f41e
...
Sub Rubbers_Hit(idx)
    ...
    If finalspeed > 20 then
        PlaySound "fx_rubber", 0, 2*Vol(ActiveBall), audiopan(ActiveBall), 0, Pitch(ActiveBall), 1, 0
    End if
...
Sub RandomSoundFlipper()
    Select Case Int(Rnd * 3) + 1
        Case 1:PlaySound "fx_flip_hit_1", 0, 2*Vol(ActiveBall), audiopan(ActiveBall), 0, Pitch(ActiveBall), 1, 0
        Case 2:PlaySound "fx_flip_hit_2", 0, 2*Vol(ActiveBall), audiopan(ActiveBall), 0, Pitch(ActiveBall), 1, 0
        Case 3:PlaySound "fx_flip_hit_3", 0, 2*Vol(ActiveBall), audiopan(ActiveBall), 0, Pitch(ActiveBall), 1, 0
    End Select
End Sub
