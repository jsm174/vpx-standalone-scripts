' ******************************************************************
'       VPX - version by Klodo81 2023, Monaco version 1.3
'
...
'    	
'
'          Monaco / IPD No.1614 / July ,1977 / 4 Players 
'
'V1.1 mod table only
' - Added typical sounds proposed by Mustang1961
' - Updated image PF and Apron
' - Fixed some little dynamic artefact around kickers
...
'- Mod script for Backglass proposed by Mustang1961
'
'V1.3 mod table
...
' Constants
Const TableName = "Monaco_77VPX"   ' file name to save highscores and other variables
Const cGameName = "Monaco1977"   ' B2S name
Const MaxPlayers = 4        ' 1 to 4 can play
Const Special1 = 530000      ' 3 Balls award credit
Const Special2 = 620000      ' 3 Balls award credit
Const Special3 = 710000      ' 3 Balls award credit
Const Special4 = 560000      ' 5 Balls award credit
Const Special5 = 640000      ' 5 Balls award credit
...
Sub EndOfBall
    ...
    If NOT Tilted Then
        ...
        Select Case BonusMultiplier
            Case 1:BonusCountTimer.Interval = 200
...
Sub BonusCountTimer_Timer 'The bonus are count when the ball is lost
    ...
    If Bonus> 0 Then
		If BonusMultiplier = 1 Then
			CBonus = CBonus + 1
			If CBonus = 5 Then	BonusCountTimer.Interval = BonusCountTimer.Interval + 150
			If CBonus = 6 Then 	BonusCountTimer.Interval = BonusCountTimer.Interval - 150
		End If
        AddScore 10000 * BonusMultiplier
        Bonus = Bonus -1
        UpdateBonusLights
		If BonusMultiplier = 2 Then Alternate
    Else 
...
Sub AddBonus
	...
	If Bonus < 10 Then
		Bonus = Bonus + 1
		If Bonus = 10 Then LightSpinner.State = 1 Else LightSpinner.State = 0
...
Sub RubberBand001_Timer
    Select Case Rub7
        Case 1:r017.Visible = 0:r013.Visible = 1:RubberBand001.TimerEnabled = 1
        Case 2:r013.Visible = 0:r035.Visible = 1
        Case 3:r035.Visible = 0:r017.Visible = 1:RubberBand001.TimerEnabled = 0
    End Select
    Rub7 = Rub7 + 1
End Sub
...
Sub KickerL_Hit
	...
	If Tilted Then
        ...
        Exit Sub
    End If
	If LightKickerLeft.State = 1 Then AddScore 10000 Else Addscore 5000
...
Sub KickerR_Hit
	...
	If Tilted Then
        ...
        Exit Sub
    End If
	If LightKickerRight.State = 1 Then AddScore 10000 Else Addscore 5000
...
Sub LeftSpinner_Spin
	...
	UpdateSpinnerLight
	If SpinCounter=10 Then AddBonus
end sub
...
Sub AddCenterBonus()
	If CenterBonusCounter < 10 Then CenterBonusCounter = CenterBonusCounter + 1 Else CenterBonusCounter = 1
	UpdateCenterBonusLights
End Sub

Sub UpdateCenterBonusLights
	Select Case CenterBonusCounter
	Case 1 : BL01.State = 1 : BL02.State = 0 : BL03.State = 0 : BL04.State = 0 : BL05.State = 0 : BL06.State = 0 : BL07.State = 0 : BL08.State = 0 : BL09.State = 0 : BL10.State = 0
	Case 2 : BL01.State = 0 : BL02.State = 1 : BL03.State = 0 : BL04.State = 0 : BL05.State = 0 : BL06.State = 0 : BL07.State = 0 : BL08.State = 0 : BL09.State = 0 : BL10.State = 0
	Case 3 : BL01.State = 0 : BL02.State = 0 : BL03.State = 1 : BL04.State = 0 : BL05.State = 0 : BL06.State = 0 : BL07.State = 0 : BL08.State = 0 : BL09.State = 0 : BL10.State = 0
	Case 4 : BL01.State = 0 : BL02.State = 0 : BL03.State = 0 : BL04.State = 1 : BL05.State = 0 : BL06.State = 0 : BL07.State = 0 : BL08.State = 0 : BL09.State = 0 : BL10.State = 0
	Case 5 : BL01.State = 0 : BL02.State = 0 : BL03.State = 0 : BL04.State = 0 : BL05.State = 1 : BL06.State = 0 : BL07.State = 0 : BL08.State = 0 : BL09.State = 0 : BL10.State = 0
	Case 6 : BL01.State = 0 : BL02.State = 0 : BL03.State = 0 : BL04.State = 0 : BL05.State = 0 : BL06.State = 1 : BL07.State = 0 : BL08.State = 0 : BL09.State = 0 : BL10.State = 0
	Case 7 : BL01.State = 0 : BL02.State = 0 : BL03.State = 0 : BL04.State = 0 : BL05.State = 0 : BL06.State = 0 : BL07.State = 1 : BL08.State = 0 : BL09.State = 0 : BL10.State = 0
	Case 8 : BL01.State = 0 : BL02.State = 0 : BL03.State = 0 : BL04.State = 0 : BL05.State = 0 : BL06.State = 0 : BL07.State = 0 : BL08.State = 1 : BL09.State = 0 : BL10.State = 0
	Case 9 : BL01.State = 0 : BL02.State = 0 : BL03.State = 0 : BL04.State = 0 : BL05.State = 0 : BL06.State = 0 : BL07.State = 0 : BL08.State = 0 : BL09.State = 1 : BL10.State = 0
	Case 10 : BL01.State = 0 : BL02.State = 0 : BL03.State = 0 : BL04.State = 0 : BL05.State = 0 : BL06.State = 0 : BL07.State = 0 : BL08.State = 0 : BL09.State = 0 : BL10.State = 1
	End Select
End Sub
