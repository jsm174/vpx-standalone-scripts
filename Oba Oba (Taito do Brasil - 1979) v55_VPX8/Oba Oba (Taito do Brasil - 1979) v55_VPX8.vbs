' Oba Oba - Taito do Brasil 1979
' IPD No. 4572 / 4 Players
...
Dim bsTrough, dtbank1, bsSaucer, x

Const cGameName = "obaoba"
...
'NVramPatchLoad
    ...
    With Controller
        ...
        .SplashInfoLine = "Oba Oba - Taito do Brasil 1979" & vbNewLine & "VPX table by JPSalas v5.5.0"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
    ...
    bsSaucer.InitSaucer sw4, 4, 0, 20
    ...
    dtbank1.InitDrop Array(sw2,sw12,sw22,sw32,sw42), Array(2,12,22,32,42)
...
Sub sw52_Hit:vpmTimer.PulseSw 52:Rub1 = 1:sw52_Timer:End Sub
Sub sw52_Timer
    Select Case Rub1
        Case 1:r1.Visible = 0:r2.Visible = 1:sw52.TimerEnabled = 1
        Case 2:r2.Visible = 0:r3.Visible = 1
        Case 3:r3.Visible = 0:r1.Visible = 1:sw52.TimerEnabled = 0
    End Select
    Rub1 = Rub1 + 1
End Sub

Sub rsband010_Hit:Rub2 = 1:rsband010_Timer:End Sub
Sub rsband010_Timer
    Select Case Rub2
        Case 1:r4.Visible = 0:r5.Visible = 1:rsband010.TimerEnabled = 1
        Case 2:r5.Visible = 0:r6.Visible = 1
        Case 3:r6.Visible = 0:r4.Visible = 1:rsband010.TimerEnabled = 0
    End Select
    Rub2 = Rub2 + 1
End Sub
...
Sub sw4_Hit:PlaysoundAt "fx_kicker_enter", sw4:bsSaucer.AddBall 0:End Sub
...
Sub sw25_Hit:vpmTimer.PulseSw 25:PlaySoundAtBall SoundFX("fx_target", DOFDropTargets):End Sub
...
Sub sw54_Hit:vpmTimer.PulseSw 54:PlaySoundAtBall SoundFX("fx_target", DOFDropTargets):End Sub
...
SolCallback(2) = "SetLamp 161,"
SolCallback(3) = "SetLamp 163,"
SolCallback(4) = "SetLamp 162,"
SolCallback(5) = "bsSaucer.SolOut"
SolCallback(6) = "dtbank1.SolDropUp"
...
Sub UpdateLamps()
    ...
    Lamp 99, li99
	' bumpers
	Lampm 161, BumperL001a
	Lamp 161, BumperL001
	Lampm 162, BumperL002a
	Lamp 162, BumperL002
	Lampm 163, BumperL003a
	Lamp 163, BumperL003
    'backdrop lights
        Lamp 139, li139
        Lamp 140, li140
