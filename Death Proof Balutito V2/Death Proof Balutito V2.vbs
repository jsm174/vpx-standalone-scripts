...
' Version 1.0
' 
' Mod of MOUSIN' AROUN (Bally/Midway, 1989) by BALUTITO 2021
'
'
' Mousin' Around (Version 1.1) Great development by Herweh 2019 for Visual Pinball 10 
'
'
' First of all : Thanks to Herweh to let me modify this table. Also Thanks to everybody who worked on this table with him (and before under VP9)
'
' FOR YOUR INFO:
...
cPuPPack = "deathproof"    ' name of the PuP-Pack / PuPVideos folder for this table
...
Sub MousinAround_Exit()		: Controller.Stop : End Sub
...
Sub MousinAround_KeyDown(ByVal keycode)
    If keycode = StartGameKey Then pupevent 803
