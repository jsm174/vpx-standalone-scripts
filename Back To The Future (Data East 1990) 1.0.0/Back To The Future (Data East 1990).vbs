...
'Flipper nFozzy
If keycode = LeftFlipperKey Then FlipperActivate LeftFlipper, LFPress 'nfozzy
If keycode = RightFlipperKey Then FlipperActivate RightFlipper, RFPress'nfozzy
...
If keycode = LeftFlipperKey Then FlipperDeActivate LeftFlipper, LFPress 'nfozzy
If keycode = RightFlipperKey Then FlipperDeActivate RightFlipper, RFPress  'nfozzy
