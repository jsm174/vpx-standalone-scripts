...
cPuPPack = "SpookyWednesdayPro"    ' name of the PuP-Pack / PuPVideos folder for this table
...
'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX 
	...
	soundtrackvol = 65 'Set the background audio volume to whatever you'd like out of 100
...
Sub InitPuP
	...
	PuPlayer.Init pBackglass,"SpookyWednesdayPro"
	If useB2SBG = 1 Then
		PuPlayer.Init pBackglass,"SpookyWednesdayPro"		
	End If
    PuPlayer.Init pFullDMD,"SpookyWednesdayPro"
    PuPlayer.Init pTopper2,"SpookyWednesdayPro"
	PuPlayer.Init pMusic,"SpookyWednesdayPro"
	PuPlayer.Init pAudio,"SpookyWednesdayPro"
	PuPlayer.Init pCallouts,"SpookyWednesdayPro"
	If toppervideo = 1 Then
	PuPlayer.Init pTopper,"SpookyWednesdayPro"
	If useB2SBG = 1 Then
		PuPlayer.Init pBackglass,"SpookyWednesdayPro"		
	End If
	End If
...
Const cGameName = "SpookyWednesdayPro"
...
Const TableName = "SpookyWednesdayPro"
Const myVersion = "5.2"
...
Sub Table1_Init()
   ...
   '******************************************************
    'DiscoMBKickbackKickerTrigger.Enabled = 1
    PuPlayer.playlistplayex pMusic,"audioattract","",0,0
    Start_Fog
    PuPlayer.playlistplayex pFullDMD,"fulldmd","FDMD_AllCleared.mkv",0,0
    PuPlayer.SetBackground pFullDMD,1
    PuPlayer.playlistplayex pTopper2,"TopperBase","",0,1
...
' SingleMode Magnet
   ...
   '****************************************************
    APGlow.State=1
    PuPlayer.playlistplayex pBackglass,"scene","Pre-IntroDMD.mkv",videovol,1
    PuPlayer.SetBackground pBackglass,1
    PuPlayer.playlistplayex pBackglass,"videoattract","HighScore.mkv",videovol,1
   	PuPlayer.SetBackground pBackglass,1
End Sub
...
'********************************************************************
 ...
 PuPlayer.playlistplayex pCallouts,"AudioBallLost","",calloutvol,1
'********************************************************************
...
'********************************************************************
 ...
 beacononLMBLoff
 beaconoff
 DiscoMBKickbackKickerTrigger.Enabled = 0
 DMKickbackKicker.Enabled = False
 QON.Enabled = True
 QON2.Enabled = False
 QON3.Enabled = True
...
Sub StartAttractMode()
   ...
   '****************************************************
    PuPlayer.playlistplayex pBackglass,"videoattract","intro-smaller.mkv",videovol,1
    PuPlayer.SetBackground pBackglass,1
    PuPlayer.playlistplayex pMusic,"audiobgrock","",0, 0
	StartDiscoAttract
...
Sub AlabardaAnim
    ...
    ZombieShake
    ZombieBloodSplattering
    ZombieBloodSplatteringTimer.Enabled = True
    'playsound "Scream 8"
...
Sub Game_Init()
    ...
    ApronSpiderTrigger.Enabled = True
    PuPlayer.playlistplayex pFullDMD,"fulldmd","fulldmd.mkv",0,1
    PuPlayer.SetBackground pFullDMD,1		
	PuPlayer.playlistplayex pCallouts,"audiocallouts","EvilLauch.mp3",calloutvol,1
    PuPlayer.playlistplayex pBackglass,"videosnapstart","SnapSnap.mkv",videovol,1
    PuPlayer.playlistplayex pBackglass,"scene","base.mkv",0,0
    PuPlayer.SetBackground pBackglass,1
    GIOFFWIZARDTrigger.Enabled = False
    GIOFFWIZARDTrigger001.Enabled = false
    GIOFFWIZARDTrigger002.Enabled = false
...
PuPlayer.playlistplayex pBackglass,"FoundTheHyde","FoundTheHyde.mkv",95,1
...
'****************************************************************************************
 ...
 PuPlayer.playlistplayex pBackglass,"WheresTheHydeLock","WheresTheHydeLock2.mkv",videovol,1
...
'****************************************************************************************
 ...
 MBBlockerlight005.state = 2
 'chilloutthemusic
 PuPlayer.playlistplayex pBackglass,"WheresTheHydeLock","WheresTheHydeLock1.mkv",videovol,1
...
'****************************************************************************************
PuPlayer.playlistplayex pBackglass,"videoHydelock","HydeLockTwo.mkv",videovol,1
PuPlayer.playlistplayex pMusic,"audiomodes","HydeLockTwo,mp3",0,1
PuPlayer.playlistplayex pMusic,"audiobgrock","",0,0
beacononLMBL
BRAnimation.Enabled = True
bMultiBallMode = True
...
'****************************************************************************************
 ...
 PuPlayer.playlistplayex pBackglass,"videoHydelock","HydeLockOne.mkv",videovol,1
...
'****************************************************************************************
 ...
 PuPlayer.playlistplayex pBackglass,"videoHydelit","This Kitty is LIT.mkv",videovol,1
...
'****************************************************************************************
PuPlayer.playlistplayex pBackglass,"videoHydemb","EnidvsHydeMB.mkv",videovol,1
...
If bMultiBallMode then Exit Sub
 ...
 If ComboM = 6 Then
     ...
     MBBlockerlight004.state = 2
     MBBlockerlight005.state = 2
     PuPlayer.playlistplayex pBackglass,"videoDiscoPartyLit","DiscoPartyLit001.mkv",videovol,1
 ...
 If ComboM = 9 Then
     ...
     MBBlockerlight004.state = 2
     MBBlockerlight005.state = 2
     PuPlayer.playlistplayex pBackglass,"videoDiscoPartyLit","DiscoPartyLit002.mkv",videovol,1
...
Sub ComboMultiball()
    ...
    GIMBRESET2.Enabled = True
 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
 'Start DiscoPartyMB
 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
	PuPlayer.playlistplayex pBackglass,"videoDiscoPartyMB","DiscoPartyMB.mkv",videovol,1
...
'*****************************************************
'****Quotes**** SCAnimation.Enabled = True
...
Sub BloodRampT1_Hit
	BloodRamp1.visible = True
 End Sub

Sub BloodRampT2_Hit
	BloodRamp2.visible = True
 End Sub

Sub BloodRampT3_Hit
	BloodRamp3.visible = True
 End Sub

Sub BloodRampT4_Hit
	BloodRamp4.visible = True
 End Sub

Sub BloodRampT5_Hit
	BloodRamp5.visible = True
 End Sub

Sub BloodRampT6_Hit
	BloodRamp6.visible = True
 End Sub


Sub BloodRampT7_Hit
	BloodRamp7.visible = True
 End Sub

Sub BloodRampT8_Hit
	BloodRamp8.visible = True
 End Sub

Sub BloodRampT9_Hit
	BloodRamp9.visible = True
 End Sub

Sub BloodRampT10_Hit
	BloodRamp10.visible = True
 End Sub

Sub BloodRampT11_Hit
	BloodRamp11.visible = True
 End Sub

Sub BloodRampT12_Hit
	BloodRamp12.visible = True
 End Sub

Sub BloodRampT13_Hit
	BloodRamp13.visible = True
 End Sub

Sub BloodRampT14_Hit
	BloodRamp14.visible = True
 End Sub


Sub BloodRampT15_Hit
	BloodRamp15.visible = True
 End Sub

Sub BloodRampT16_Hit
	BloodRamp16.visible = True
 End Sub

Sub BloodRampT17_Hit
	BloodRamp17.visible = True
 End Sub

Sub BloodRampT18_Hit
	BloodRamp18.visible = True
 End Sub

Sub BloodRampT19_Hit
	BloodRamp19.visible = True
    'BRAnimation.Enabled = True
 End Sub

Sub BloodRampT20_Hit
	BloodRamp20.visible = True
    BloodRamp21.visible = True
 End Sub
...
Sub BloodRampToff_Hit
	BloodRamp1.visible = False
    BloodRamp2.visible = False
    BloodRamp3.visible = False
    BloodRamp4.visible = False
    BloodRamp5.visible = False
    BloodRamp6.visible = False
    BloodRamp7.visible = False
    BloodRamp8.visible = False
    BloodRamp9.visible = False
    BloodRamp10.visible = False
    BloodRamp11.visible = False
    BloodRamp12.visible = False
    BloodRamp13.visible = False
    BloodRamp14.visible = False
    BloodRamp15.visible = False
    BloodRamp16.visible = False
    BloodRamp17.visible = False
    BloodRamp18.visible = False
    BloodRamp19.visible = False
    BloodRamp20.visible = False
    BloodRamp21.visible = False
 End Sub
...
'************************************************************************
'			Attack Beacon Kill Timer
'************************************************************************

'Sub Attackbeacontimeroff 'in timer options look at the interval, its 2500 2 1/2 seconds
    'AttackBeaconTimerKill.Enabled = 1 'after 2 1/2 seconds Timer1 stops and finishes the Sub
   ' beacononRMBLoff
   '' beacononLMBLoff
   ' beaconoff
'End Sub
...
Sub HydeSuperJackpotTrigger_Hit()
    SlimerHitPos = 6:SlimerHitTimer.Enabled = 1
   ' Kill Hyde JACKPOT during Multiball (if ballsonpf = 2):
PuPlayer.playlistplayex pBackglass,"videoHydeKilled","HydeKilled.mkv",videovol,1
PuPlayer.playlistplayex pMusic,"audiomodes","HydeKilled.mp3",0,1
PuPlayer.playlistplayex pMusic,"audiobgrock","",0,0
PuPlayer.playlistplayex pFullDMD,"fulldmd","EVHCleared.mkv",0,0
PuPlayer.SetBackground pFullDMD,1
PuPlayer.playlistplayex pTopper2,"Topper","EVHCtopper.mkv",Topper2vol,1
addscore 250000
...
FullDMDVideoTrigger.Enabled = True
FullDMDVideoTriggerOff.Enabled = True
DiscoMBKickbackKickerTrigger.Enabled = 0
DMKickbackKicker.Enabled = False
CheckFullDMDTimer.Enabled = True
end sub 
...
playsound "Superjackpot"
PuPlayer.playlistplayex pFullDMD,"fulldmd","WTHCleared.mkv",0,0
PuPlayer.SetBackground pFullDMD,1
PuPlayer.playlistplayex pTopper2,"Topper","EVHCtopper.mkv",Topper2vol,1
...
FullDMDVideoTriggerOff.Enabled = True
DiscoMBKickbackKickerTrigger.Enabled = 0
DMKickbackKicker.Enabled = True
CheckFullDMDTimer.Enabled = True
DiscoSpotLightL.state = 0
DiscoSpotLightR.state = 0
end sub 
...
Sub StartWheresHMB_Timer() 'in timer options look at the interval, its 2500 2 1/2 seconds
    ...
    Starthydespin
    DiscoSpotLightL.state = 1
    DiscoSpotLightR.state = 1
    GraveStoneSuperTarget001.Isdropped = 1
    GraveStoneSuperTarget002.Isdropped = 1
    GraveStoneSuperTarget003.Isdropped = 1
    grave001tragertimer002.Enabled = False
    ...
    Drain.Enabled = 0
    DiscoMBKickbackKickerTrigger.Enabled = 1
    PuPlayer.playlistplayex pBackglass,"videoFoundTheHydeMB","FoundTheHydeMB.mkv",90,1
...
Sub DiscoJackpotTrigger001_Hit
    ...
    PuPlayer.playlistplayex pCallouts,"AudioJackpots","",80,0
...
Sub DiscoJackpotTrigger005_Hit
    ...
    PuPlayer.playlistplayex pCallouts,"AudioSuperJackpots","",80,1
...
Sub DiscoSuperJackpotTrigger_Hit
    ...
    PuPlayer.playlistplayex pCallouts,"audiocallouts","DiscoCleared.mp3",80,1
    DiscoSuperJackpotTrigger.Enabled = False 
    DiscoJackpotTrigger005.Enabled = False 
    DiscoJackpotTrigger004.Enabled = False 
    DiscoJackpotTrigger003.Enabled = False 
    ...
    EnidMBLightSeq.StopPlay
    MBBlocker003.Isdropped = 1
    PuPlayer.playlistplayex pBackglass,"videoDiscoPartyMB","DiscoPartyOver.mkv",videovol,1
    PuPlayer.playlistplayex pAudio,"audiobgrock","",0,0
    PuPlayer.playlistplayex pMusic,"audiomodes","DiscoPartyOver.mp3",0,1
    PuPlayer.playlistplayex pFullDMD,"fulldmd","RDMBCleared.mkv",0,0
    PuPlayer.SetBackground pFullDMD,1
    PuPlayer.playlistplayex pTopper2,"Topper","EVHCtopper.mkv",Topper2vol,1
    playsound "ModeCleared"
    WizardSaverKicker.Enabled = False
...
Sub JailTrigger005_Hit
    ...
    NightShadeGIOff
    SpotlightAttractOff
    PuPlayer.playlistplayex pBackglass,"FreeGomezMode","GomezFreed.mkv",115,1
    PuPlayer.playlistplayex pMusic,"audiomodes","GomezFreed.mp3",0,1
    PuPlayer.playlistplayex pMusic,"audiobgrock","",0,0
    DMDFlush
    DMD "dmd baseBlank.png", "", "", 300
    DMD "FGMSetFree.png", "", "", 3800
    PuPlayer.playlistplayex pFullDMD,"fulldmd","WTH_FGCleared.mkv",0,0
    PuPlayer.SetBackground pFullDMD,1
    FullDMDVideoTrigger.Enabled = True
    FullDMDVideoTriggerOff.Enabled = True
    CheckFullDMDTimer.Enabled = True
    PuPlayer.playlistplayex pTopper2,"Topper","FGKCtopper.mkv",Topper2vol,1
end sub 
...
Sub JailTimer001On_Timer() 'in timer options look at the interval, its 2500 2 1/2 seconds
    ...
    FGL001.State = 2
    StartJailKeySpin
    PuPlayer.playlistplayex pBackglass,"FreeGomezMode","FreeGomezMode.mkv",115,1
    PuPlayer.playlistplayex pMusic,"audiomodes","FreeGomezMode.mp3",0,1
    PuPlayer.playlistplayex pMusic,"audiobgrock","",0,0
    DMDFlush
    DMD "dmd baseBlank.png", "", "", 300
    DMD "FreeGomezMode.png", "", "", 3800
    FreeGomezFlasher.opacity = 97
...
Sub JailTimer001OFF_Timer() 'in timer options look at the interval, its 2500 2 1/2 seconds
   ...
   SingleModeKillerTrigger.Enabled = False
   CheckFullDMDTimer.Enabled = True
   CheckFullDMDTimer2.Enabled = True
end sub 
...
Sub FreeGomezLitVideoTimer_Timer() 'in timer options look at the interval, its 2500 2 1/2 seconds
    ...
    PuPlayer.playlistplayex pBackglass,"FreeGomezMode","GomezArrested.mkv",115,1
...
Sub EugeneTrigger005_Hit
    ...
    SpotlightAttractOff
    StartLOGOAni
    PuPlayer.playlistplayex pBackglass,"SaveEugeneMode","EugeneSaved.mkv",115,1
    DMDFlush
    DMD "dmd baseBlank.png", "", "", 300
    ...
    SingleModeKillerTrigger.Enabled = True
    PuPlayer.playlistplayex pFullDMD,"fulldmd","RD_SECleared.mkv",0,0
    PuPlayer.SetBackground pFullDMD,1
    PuPlayer.playlistplayex pTopper2,"Topper","EGCtopper.mkv",Topper2vol,1
    FullDMDVideoTrigger.Enabled = True
    FullDMDVideoTriggerOff.Enabled = True
    CheckFullDMDTimer.Enabled = True
end sub 
...
Sub EugeneTimer001On_Timer() 'in timer options look at the interval, its 2500 2 1/2 seconds
    ...
    DiscoBlocker.Isdropped = 1
    FGL001.State = 2
    PuPlayer.playlistplayex pBackglass,"SaveEugeneMode","SaveEugeneMode.mkv",75,1
...
Sub EugeneLitVideoTimer_Timer() 'in timer options look at the interval, its 2500 2 1/2 seconds
    ...
    PuPlayer.playlistplayex pBackglass,"SaveEugeneMode","DontGoAlone.mkv",115,1
...
sub NightShadesTarger001_hit()
  ...
  PuPlayer.playlistplayex pTopper2,"Topper","N.mkv",0,1
  PuPlayer.SetBackground pTopper2,1
end sub
...
sub NightShadesTarger002_hit()
  ...
  PuPlayer.playlistplayex pTopper2,"Topper","NI.mkv",0,1
  PuPlayer.SetBackground pTopper2,1
end sub
...
sub NightShadesTarger003_hit()
  ...
  PuPlayer.playlistplayex pTopper2,"Topper","NIG.mkv",0,1
  PuPlayer.SetBackground pTopper2,1
end sub
...
sub NightShadesTarger004_hit()
  ...
  PuPlayer.playlistplayex pTopper2,"Topper","NIGH.mkv",0,1
  PuPlayer.SetBackground pTopper2,1
end sub
...
sub NightShadesTarger005_hit()
  ...
  PuPlayer.playlistplayex pTopper2,"Topper","NIGHT.mkv",0,1
  PuPlayer.SetBackground pTopper2,1
end sub
...
sub NightShadesTarger006_hit()
  ...
  DMD "dmd baseBlank.png", "", "", 300
  DMD "NSMKeepGoing.png", "", "", 3800
  PuPlayer.playlistplayex pTopper2,"Topper","NIGHTS.mkv",0,1
  PuPlayer.SetBackground pTopper2,1
end sub
...
sub NightShadesTarger007_hit()
  ...
  PuPlayer.playlistplayex pTopper2,"Topper","NIGHTSH.mkv",0,1
  PuPlayer.SetBackground pTopper2,1
end sub
...
sub NightShadesTarger008_hit()
  ...
  PuPlayer.playlistplayex pTopper2,"Topper","NIGHTSHA.mkv",0,1
  PuPlayer.SetBackground pTopper2,1
end sub
...
sub NightShadesTarger009_hit()
  ...
  DMD "dmd baseBlank.png", "", "", 300
  DMD "NSMKeepGoing.png", "", "", 3800
  PuPlayer.playlistplayex pTopper2,"Topper","NIGHTSHAD.mkv",0,1
  PuPlayer.SetBackground pTopper2,1
end sub
...
sub NightShadesTarger010_hit()
  ...
  PuPlayer.playlistplayex pTopper2,"Topper","NIGHTSHADE.mkv",0,1
  PuPlayer.SetBackground pTopper2,1
end sub
...
sub NightShadesTarger011_hit()
  ...
  PuPlayer.playlistplayex pTopper2,"Topper","NIGHTSHADE_S.mkv",0,1
  PuPlayer.SetBackground pTopper2,1
end sub
...
sub NightShadesTarger012_hit()
  ...
  DMD "dmd baseBlank.png", "", "", 300
  DMD "NSMKeepGoing.png", "", "", 3800
  PuPlayer.playlistplayex pTopper2,"Topper","NIGHTSHADE_SO.mkv",0,1
  PuPlayer.SetBackground pTopper2,1
end sub
...
sub NightShadesTarger013_hit()
  ...
  PuPlayer.playlistplayex pTopper2,"Topper","NIGHTSHADE_SOC.mkv",0,1
  PuPlayer.SetBackground pTopper2,1
end sub
...
sub NightShadesTarger014_hit()
  ...
  PuPlayer.playlistplayex pTopper2,"Topper","NIGHTSHADE_SOCI.mkv",0,1
  PuPlayer.SetBackground pTopper2,1
end sub
...
sub NightShadesTarger015_hit()
  ...
  DMD "dmd baseBlank.png", "", "", 300
  DMD "NSMKeepGoing.png", "", "", 3800
  PuPlayer.playlistplayex pTopper2,"Topper","NIGHTSHADE_SOCIE.mkv",0,1
  PuPlayer.SetBackground pTopper2,1
end sub
...
sub NightShadesTarger016_hit()
  ...
  PlaySound "soundmagnet"
  TLight2.state = 1
  PuPlayer.playlistplayex pTopper2,"Topper","NIGHTSHADE_SOCIET.mkv",0,1
  PuPlayer.SetBackground pTopper2,1
end sub
...
sub NightShadesTarger017_hit()
  ...
  DMD "dmd baseBlank.png", "", "", 300
  DMD "NSMKeepGoing.png", "", "", 3800
  PuPlayer.playlistplayex pTopper2,"Topper","NIGHTSHADE_SOCIETY.mkv",0,1
  PuPlayer.SetBackground pTopper2,1
end sub
...
sub NightShadeSJPTrigger_hit()
  ...
  ramptrigger.Enabled = True
  SingleModeKillerTrigger.Enabled = True
  PuPlayer.playlistplayex pBackglass,"Seceret Libriary","NightShadesForever.mkv",115,1
  DMDFlush
  DMD "dmd baseBlank.png", "", "", 300
  DMD "NSMBookCollected.png", "", "", 3800
  PuPlayer.playlistplayex pFullDMD,"fulldmd","EVH_NSCleared.mkv",0,0
  PuPlayer.SetBackground pFullDMD,1
  PuPlayer.playlistplayex pTopper2,"Topper","NSBCtopper.mkv",Topper2vol,1
  FullDMDVideoTrigger.Enabled = True
  FullDMDVideoTriggerOff.Enabled = True
  CheckFullDMDTimer.Enabled = True
end sub 
...
SingleModeBlocker002.Isdropped = 0
SingleModeBlocker003.Isdropped = 0
PuPlayer.playlistplayex pBackglass,"Seceret Libriary","Seceret Libriary.mkv",115,1
...
Sub StartVideoNightShadesTimer_Timer() 'in timer options look at the interval, its 2500 2 1/2 seconds
    ...
    PuPlayer.playlistplayex pBackglass,"Seceret Libriary","ComingWithUs.mkv",115,1
    PuPlayer.playlistplayex pMusic,"audiomodes","ComingWithUs.mp3",0,1
    PuPlayer.playlistplayex pMusic,"audiobgrock","",0,0
    PuPlayer.playlistplayex pTopper2,"Topper","NIGHTSHADE_BASE.mkv",0,1
    PuPlayer.SetBackground pFullDMD,1
    DMDFlush
    DMD "dmd baseBlank.png", "", "", 300
    DMD "NightshadeMode.png", "", "", 3800
...
sub MBBlockerTarget_hit()
  ...
  FlashForms AttackLight001, 1000, 50, 0
  FlashForms AttackLight002, 1000, 50, 0
  FlashForms AttackLight003, 1000, 50, 0
  FlashForms AttackLight004, 1000, 50, 0
  FlashForms AttackLight005, 1000, 50, 0
  FlashForms AttackLight006, 1000, 50, 0
  FlashForms AttackLight007, 1000, 50, 0
  FlashForms AttackLight008, 1000, 50, 0
  FlashForms AttackLight009, 1000, 50, 0
  FlashForms AttackLight010, 1000, 50, 0
  FlashForms AttackLight011, 1000, 50, 0
  FlashForms AttackLight012, 1000, 50, 0
  FlashForms AttackLight013, 1000, 50, 0
  FlashForms AttackLight014, 1000, 50, 0
  FlashForms AttackLight015, 1000, 50, 0
  FlashForms AttackLight016, 1000, 50, 0
  FlashForms AttackLight017, 1000, 50, 0
  FlashForms AttackLight018, 1000, 50, 0
  FlashForms AttackLight019, 1000, 50, 0
  FlashForms AttackLight020, 1000, 50, 0
  PlaySound "BLACK EYE"
end sub
...
Sub EndOfWizareModeTimer_Timer() 'in timer options look at the interval, its 2500 2 1/2 seconds
    ...
    WWMBAllSmallDMDsOff
    PuPlayer.playlistplayex pBackglass,"LostWizardMode","LostWizardMode.mkv",videovol,1
...
sub startwizardmodeTrigger_hit()
    ...
    PuPlayer.playlistplayex pBackglass,"WednesdayWizardMode","WednesdayWizardMode.mkv",91,1
    ...
    PuPlayer.playlistplayex pFullDMD,"fulldmd","FDMD_AllCleared.mkv",0,7
    PuPlayer.SetBackground pFullDMD,7
    WizardMagnet.MagnetOn = True
    vpmTimer.AddTimer 40, " WizardMagnet.MagnetOn = False '"
    CheckFullDMDTimer.Enabled = False
    CheckFullDMDTimer2.Enabled = False
    CheckFullDMDTimer3.Enabled = False
    WizardModeKicker.Enabled = 1
...
PuPlayer.playlistplayex pBackglass,"WizardMB","WednesdayWizardMB.mkv",92,1
PuPlayer.playlistplayex pMusic,"audiobgrock","",0,0
PuPlayer.playlistplayex pMusic,"audiomodes","WednesdayWizardMB.mp3",0,1
PuPlayer.playlistplayex pFullDMD,"fulldmd","wizardDMD.mkv",0,6
PuPlayer.SetBackground pFullDMD,6
'AudioAttractTimer001.Enabled = True
CheckFullDMDTimer.Enabled = False
CheckFullDMDTimer2.Enabled = False
CheckFullDMDTimer3.Enabled = False
...
Sub CRACKSTONESuperJackpotTrigger_Hit()
    addscore 2000000
    CStoneGoBoomBoom
    playsound "I DO LIKE STABBING"
    CstoneGoBoomTimer.Enabled = True
    WizardSpotSeq.StopPlay
    Timer002.Enabled = True
    CStoneBoomOnTimer.Enabled = True
    CStoneBoomOffTimer.Enabled = True
    ...
    PuPlayer.playlistplayex pBackglass,"EndOfWizardMode","EndWizardMode.mkv",videovol,1
    PuPlayer.playlistplayex pMusic,"audiobgrock","",0,0
...
Sub GameVideoStartTrigger_Hit()
    ...
    PuPlayer.playlistplayex pBackglass,"videosnapstart","SoItBegins.mkv",videovol,1
End Sub
...
Sub GIMBRESET_Timer() 'in timer options look at the interval, its 2500 2 1/2 seconds
    GIMBRESET.Enabled = False 'after 2 1/2 seconds Timer1 stops and finishes the Sub
    GIOFFWIZARDTrigger.Enabled = False
	GIOFFWIZARDTrigger001.Enabled = False
	GIOFFWIZARDTrigger002.Enabled = False
	GIOFFWIZARDTrigger003.Enabled = False
...
Sub GIMBRESET2_Timer() 'in timer options look at the interval, its 2500 2 1/2 seconds
    GIMBRESET2.Enabled = False 'after 2 1/2 seconds Timer1 stops and finishes the Sub
    GIOFFWIZARDTrigger.Enabled = False
	GIOFFWIZARDTrigger001.Enabled = False
	GIOFFWIZARDTrigger002.Enabled = False
	GIOFFWIZARDTrigger003.Enabled = False
...
Sub beacontime_Timer()
		beaconflashLSling.RotZ = beaconflashLSling.RotZ + 2
		beaconflashRSling.RotZ = beaconflashRSling.RotZ + 2
        beaconflashLSideFlasher.RotZ = beaconflashLSideFlasher.RotZ + 2
        beaconflashLSideFlasher2.RotZ = beaconflashLSideFlasher2.RotZ + 2
        beaconflashRSidemidFlasher.RotZ = beaconflashRSidemidFlasher.RotZ + 2
        beaconflashTopFlasher.RotZ = beaconflashTopFlasher.RotZ + 2
	...
	Sub beaconon
		...
		beaconlight1LSling.State = 1
		beaconlight2RSling.State = 1
        beaconLightLSideFlasher.State = 1
        beaconLightLSideFlasher2.State = 1
        beaconLightRmidFlasher.State = 1
        beaconLightTopFlasher.State = 1
		beaconflashLSling.opacity = 30
		beaconflashRSling.opacity = 30
        beaconflashLSideFlasher.opacity = 30
        beaconflashLSideFlasher2.opacity = 30
        beaconflashRSidemidFlasher.opacity = 30
        beaconflashTopFlasher.opacity = 30
	...
	Sub beaconoff
		...
		beaconlight1LSling.State = 0
		beaconlight2RSling.State = 0
        beaconLightLSideFlasher.State = 0
        beaconLightLSideFlasher2.State = 0
        beaconLightRmidFlasher.State = 0
        beaconLightTopFlasher.State = 0
		beaconflashLSling.opacity = 0
		beaconflashRSling.opacity = 0
        beaconflashLSideFlasher.opacity = 0
        beaconflashLSideFlasher2.opacity = 0
        beaconflashRSidemidFlasher.opacity = 0
        beaconflashTopFlasher.opacity = 0
		'DOF 319, DOFOFF ' DOF MX - Beacon OFF
		'DOF 127, DOFOff   'DOF - Beacon - OFF
	End Sub

Sub beacontimeLMBLock_Timer()
    beaconflashLMBHFlasher.RotZ = beaconflashLMBHFlasher.RotZ + 2
end Sub


Sub beacononLMBL
    beacontimeLMBLock.Enabled = True
	beaconLightLMBHFlasher.State = 1
    beaconflashLMBHFlasher.opacity = 30	
 end sub 


Sub beacononLMBLoff
    beacontimeLMBLock.Enabled = False
	beaconLightLMBHFlasher.State = 0
    beaconflashLMBHFlasher.opacity = 0	
 end sub 

Sub beacontimeRMBLock_Timer()
    beaconflashTopMBHFlasher.RotZ = beaconflashTopMBHFlasher.RotZ + 2
end Sub


Sub beacononRMBL
    beacontimeRMBLock.Enabled = True
	beaconLightTopMBHFlasher.State = 1
    beaconflashTopMBHFlasher.opacity = 30	
 end sub 


Sub beacononRMBLoff
    beacontimeRMBLock.Enabled = False
	beaconLightTopMBHFlasher.State = 0
    beaconflashTopMBHFlasher.opacity = 0	
 end sub



Sub beaconSlingtime_Timer()
	beaconflashLSling.RotZ = beaconflashLSling.RotZ + 2
	beaconflashRSling.RotZ = beaconflashRSling.RotZ + 2
   End Sub
...
'*********************************************************************************
' CHECK FULLDMD CODING
'*********************************************************************************


Sub CheckFullDMDTimer_Timer() 'in timer options look at the interval, its 2500 2 1/2 seconds
   CheckFullDMDTimer.Enabled = False 'after 2 1/2 seconds Timer1 stops and finishes the Sub
   CheckFullDMD1
   CheckFullDMDTimer2.Enabled = True
End Sub


Sub CheckFullDMDTimer2_Timer() 'in timer options look at the interval, its 2500 2 1/2 seconds
   CheckFullDMDTimer2.Enabled = False 'after 2 1/2 seconds Timer1 stops and finishes the Sub
   CheckFullDMD1
   CheckFullDMDTimer3.Enabled = True
End Sub

Sub CheckFullDMDTimer3_Timer() 'in timer options look at the interval, its 2500 2 1/2 seconds
   CheckFullDMDTimer3.Enabled = False 'after 2 1/2 seconds Timer1 stops and finishes the Sub
   CheckFullDMD1
End Sub


Sub CheckFullDMD1()
if HydeModeDone.state = 1 and HYDEMB2Done.state = 1 Then
PuPlayer.playlistplayex pFullDMD,"fulldmd","EVH_WTH.mkv",0,5
PuPlayer.SetBackground pFullDMD,5
end If
if HYDEMB2Done.state = 1 and DiscoPartyDone.state = 1 Then
PuPlayer.playlistplayex pFullDMD,"fulldmd","WTH_RDCleared.mkv",0,5
PuPlayer.SetBackground pFullDMD,5
end If
if HydeModeDone.state = 1 and DiscoPartyDone.state = 1 Then
PuPlayer.playlistplayex pFullDMD,"fulldmd","EVH_RDCleared.mkv",0,5
PuPlayer.SetBackground pFullDMD,5
end If
if DiscoPartyDone.state = 1 and Eugene.State= 1  then
PuPlayer.playlistplayex pFullDMD,"fulldmd","RD_SECleared.mkv",0,5
PuPlayer.SetBackground pFullDMD,5
end if
if HydeModeDone.state = 1 and HYDEMB2Done.state = 1 and DiscoPartyDone.state = 1 Then
PuPlayer.playlistplayex pFullDMD,"fulldmd","AllMBCleared.mkv",0,5
PuPlayer.SetBackground pFullDMD,5
end If
if HydeModeDone.state = 1 and DiscoPartyDone.state = 1 and Biannca.State= 1  then
PuPlayer.playlistplayex pFullDMD,"fulldmd","EVH_NS_RDCleared.mkv",0,5
PuPlayer.SetBackground pFullDMD,5
end if
if HydeModeDone.state = 1 and HYDEMB2Done.state = 1 and Biannca.State= 1  then
PuPlayer.playlistplayex pFullDMD,"fulldmd","EVH_NS_WTHClearde.mkv",0,5
PuPlayer.SetBackground pFullDMD,5
end if
if HYDEMB2Done.state = 1 and DiscoPartyDone.state = 1 and Eugene.State= 1 and Glasses.visible = 1  then
PuPlayer.playlistplayex pFullDMD,"fulldmd","EVH_RD_SECleared.mkv",0,5
PuPlayer.SetBackground pFullDMD,5
end if 
if HydeModeDone.state = 1 and DiscoPartyDone.state = 1 and Eugene.State= 1 and Glasses.visible = 1  then
PuPlayer.playlistplayex pFullDMD,"fulldmd","EVH_RD_SECleared.mkv",0,5
PuPlayer.SetBackground pFullDMD,5
end if
if HYDEMB2Done.state = 1 and DiscoPartyDone.state = 1 and Eugene.State= 1 and Glasses.visible = 1  then
PuPlayer.playlistplayex pFullDMD,"fulldmd","WTH_RD_SECleared.mkv",0,5
PuPlayer.SetBackground pFullDMD,5
end if 
if HYDEMB2Done.state = 1 and DiscoPartyDone.state = 1 and Addams2.State= 1  then
PuPlayer.playlistplayex pFullDMD,"fulldmd","FG_WTH_RDcleared.mkv",0,5
PuPlayer.SetBackground pFullDMD,5
end if
if HydeModeDone.state = 1 and HYDEMB2Done.state = 1 and Addams2.State= 1  then
PuPlayer.playlistplayex pFullDMD,"fulldmd","EVH_WTH_FGcleared.mkv",0,5
PuPlayer.SetBackground pFullDMD,5
end if
if HydeModeDone.state = 1 and HYDEMB2Done.state = 1 and DiscoPartyDone.state = 1 and Addams2.State= 1  then
PuPlayer.playlistplayex pFullDMD,"fulldmd","FG_EVH_WTH_RDcleared.mkv",0,5
PuPlayer.SetBackground pFullDMD,5
end if
if HydeModeDone.state = 1 and HYDEMB2Done.state = 1 and DiscoPartyDone.state = 1 and Biannca.State= 1 then
PuPlayer.playlistplayex pFullDMD,"fulldmd","EVH_NS_WTH_RDCleared.mkv",0,5
PuPlayer.SetBackground pFullDMD,5
end if
if HydeModeDone.state = 1 and HYDEMB2Done.state = 1 and DiscoPartyDone.state = 1 and Eugene.State= 1 and Glasses.visible = 1  then
PuPlayer.playlistplayex pFullDMD,"fulldmd","EVH_WTH_RD_SECleared.mkv",0,5
PuPlayer.SetBackground pFullDMD,5
end if
if HydeModeDone.state = 1 and HYDEMB2Done.state = 1 and Biannca.State= 1 and Addams2.State= 1 then
PuPlayer.playlistplayex pFullDMD,"fulldmd","EVHWTHNSFGCleared.mkv",0,5
PuPlayer.SetBackground pFullDMD,5
end if
if HydeModeDone.state = 1 and DiscoPartyDone.state = 1 and Biannca.State= 1 and Eugene.State= 1 then
PuPlayer.playlistplayex pFullDMD,"fulldmd","EVH_RD_NS_SECleared.mkv",0,5
PuPlayer.SetBackground pFullDMD,5
end if 
if HYDEMB2Done.state = 1 and DiscoPartyDone.state = 1 and Addams2.State= 1 and Eugene.State= 1 then
PuPlayer.playlistplayex pFullDMD,"fulldmd","WTH_RD_FG_SECleared.mkv",0,5
PuPlayer.SetBackground pFullDMD,5
end if 
if HydeModeDone.state = 1 and HYDEMB2Done.state = 1 and DiscoPartyDone.state = 1 and Biannca.State= 1 and Addams2.State= 1 then
PuPlayer.playlistplayex pFullDMD,"fulldmd","EVH_WTH_RD_NS_FGCleared.mkv",0,5
PuPlayer.SetBackground pFullDMD,5
end if
if HydeModeDone.state = 1 and HYDEMB2Done.state = 1 and DiscoPartyDone.state = 1 and Biannca.State= 1 and Eugene.State= 1  then
PuPlayer.playlistplayex pFullDMD,"fulldmd","EVH_WTH_RD_NS_SE.mkv",0,5
PuPlayer.SetBackground pFullDMD,5
end if
if HydeModeDone.state = 1 and HYDEMB2Done.state = 1 and DiscoPartyDone.state = 1 and Addams2.State= 1 and Eugene.State= 1  then
PuPlayer.playlistplayex pFullDMD,"fulldmd","EVH_WTH_RD_FG_SECleared.mkv",0,5
PuPlayer.SetBackground pFullDMD,5
end if
end sub
...
'*********************************************************************************
' Orbit Scoring Triggers Cstone go boom and zomvie splattering
'*********************************************************************************

sub RightOrbitTiggerScoring_hit()
    if J4.state = 2 then
    addscore 20000
  end if 
  End Sub

sub LeftOrbitTiggerScoring_hit()
    if J1.state = 2 then
    addscore 20000
  end if 
  End Sub
...
sub DiscoMBKickbackKickerTrigger_hit()
    DMKickbackKicker.Enabled = true
  end sub


Sub DMKickbackKicker_Hit()
DMKickbackKicker.Kick 2, 30
PlaySound "I'M GOING TO LOVE IT HERE"
end sub


sub ApronSpiderTrigger_hit()
    PlaySound "THAT WAS TORTURE "
    SC003Animation.Enabled = True
    if BallsOnPlayfield = 2 then
    ApronSpiderTrigger.Enabled = False
    end if 
    if BallsOnPlayfield = 3 then
    ApronSpiderTrigger.Enabled = False
    end if 
...
sub CStoneGoBoomBoom 
flashforms  CStoneExplosion,2000, 50, 0
flashforms  CStoneExplosion002,2100, 30, 0
flashforms  CStoneExplosion003,2300, 20, 0
flashforms  CStoneExplosion004,2400, 20, 0
end sub


Sub CstoneGoBoomTimer_Timer() 'in timer options look at the interval, its 2500 2 1/2 seconds
    CstoneGoBoomTimer.Enabled = False 'after 2 1/2 seconds Timer1 stops and finishes the Sub
    CstoneGoBoomTimer001.Enabled = True
    CStoneGoBoomBoom
End Sub


Sub CstoneGoBoomTimer2_Timer() 'in timer options look at the interval, its 2500 2 1/2 seconds
    CstoneGoBoomTimer001.Enabled = False 'after 2 1/2 seconds Timer1 stops and finishes the Sub
    CStoneGoBoomBoom
End Sub



sub ZombieBloodSplattering 
    flashforms  ZombieBloodSplatter,700, 70, 0
end Sub

Sub ZombieBloodSplatteringTimer_Timer() 'in timer options look at the interval, its 2500 2 1/2 seconds
    ZombieBloodSplatteringTimer.Enabled = False 'after 2 1/2 seconds Timer1 stops and finishes the Sub
    ZombieBloodSplattering
End Sub
