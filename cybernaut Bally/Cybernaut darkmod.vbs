...
Sub Saucer1_Hit:bsSaucer.addball 0: playsound"popper_ball" :PFcollectbonus.Duration 0, 900, 1 :PFcollectbonus1.Duration 0, 900, 1:PFcollectbonus2.Duration 0, 900, 1:PFion.Duration 0,900,1
Giplasleft.Duration 0,900,1:Giplasrightup.Duration 0,900,1:Giplasleft.Duration 0,900,1
PFbumper.Duration 0, 650, 1: PFrightmid.Duration 0, 650, 1:Giplasbumper.Duration 0,650,1 :Giplasbumper2.Duration 0,650,1::Giplasright.Duration 0,650,1:PFslingleft.Duration 0, 400, 1:PFslingleft1.Duration 0, 400, 1:PFslingleft2.Duration 0, 400, 1:PFslingleft3.Duration 0, 400, 1
PFslingright.Duration 0, 400, 1:PFslingright1.Duration 0, 400, 1:PFslingright2.Duration 0, 400, 1:PFslingright3.Duration 0, 400, 1:GIplasslingleft.Duration 0,400,1:GIplasslingright.Duration 0,400,1:End Sub  

Sub Trigger3_Hit:playsound"goner"End Sub
Sub Trigger4_Hit:playsound"goner"End Sub
Sub Gate1_Hit : shooterlane.state=2:End Sub
...
Sub sw12_Hit()        : controller.switch (swTube)=1 :playsound"rail_low_slower":Giplasleft.Duration 0,500,1
                        PFbumper.Duration 0, 500, 1: PFrightmid.Duration 0, 500, 1:Giplasbumper.Duration 0,500,1 :Giplasbumper2.Duration 0,500,1::Giplasright.Duration 0,500,1:End Sub
Sub sw12_unHit()      : controller.switch (swTube)=0 : End Sub



'Wire Triggers
Sub sw14_Hit()   	  : controller.switch (swShooterLane)=1 : playsound"rollover" : shooterlane.state=0:End Sub  
Sub sw14_unHit() 	  : controller.switch (swShooterLane)=0:End Sub

Sub sw13_Hit()		  : controller.switch (swTopRightLane)=1 : playsound"rollover" : End Sub 
...
'Bumpers
Sub Bumper_Hit : vpmTimer.PulseSw(1) : playsound SoundFX("fx_bumper1",DOFContactors): FlashLevel2=2:FlasherFlash2_Timer:End Sub

 'Stand Up Targets

 Sub sw34_Hit : vpmTimer.PulseSw(swLeft) 

     targetlight.Duration 2,1000,0

 End Sub

 Sub sw36_Hit : vpmTimer.PulseSw(swRight1)

     targetlight2.Duration 2,1000,0

 End Sub
 
 Sub sw35_Hit : vpmTimer.PulseSw(swRight2)  

     targetlight1.Duration 2,1000,0
...
GIionleft1.Duration 0,600,1:GIionleft2.Duration 0,600,1:GIionleft3.Duration 0,600,1:GIionleft4.Duration 0,600,1:GIionleft5.Duration 0,600,1:GIionleft6.Duration 0,600,1:GIplasion.Duration 0,600,1:GIplasion.Duration 0,600,1:GIplasion1.Duration 0,600,1
GIionright1.Duration 0,600,0: GIionright3.Duration 0,600,0: GIionright4.Duration 0,600,0 : GIshooterlane.Duration 0,600,0 
PFcollectbonus.Duration 0, 600, 1 :PFcollectbonus1.Duration 0, 600, 1:PFcollectbonus2.Duration 0, 600, 1:PFion.Duration 0,600,1
Giplasleftup.Duration 0,600,1:Giplasrightup.Duration 0,600,1:Giplasleft.Duration 0,600,1
PFbumper.Duration 0, 600, 1: PFrightmid.Duration 0, 600, 1:Giplasbumper.Duration 0,600,1 :Giplasbumper2.Duration 0,600,1::Giplasright.Duration 0,600,1:PFslingleft.Duration 0, 600, 1:PFslingleft1.Duration 0, 600, 1:PFslingleft2.Duration 0, 600, 1:PFslingleft3.Duration 0, 600, 1
PFslingright.Duration 0, 600, 1:PFslingright1.Duration 0, 600, 1:PFslingright2.Duration 0, 600, 1:PFslingright3.Duration 0, 600, 1:GIplasslingleft.Duration 0,600,1:GIplasslingright.Duration 0,600,1 :GIstar.Duration 0,600,1 
     End If
End Sub

Sub SW18_Timer:Primitive_TargetParts4.ObjRotx=0:Primitive_TargetParts7.ObjRotx = 0:Me.TimerEnabled=0:FlashLevel1=1:FlasherFlash1_Timer:End Sub
...
Sub SW19_Timer:Primitive_TargetParts3.ObjRotx=0:Primitive_TargetParts6.ObjRotx = 0:Me.TimerEnabled=0:FlashLevel1=1:FlasherFlash1_Timer:End Sub
...
Sub SW20_Timer:Primitive_TargetParts2.ObjRotx=0:Primitive_TargetParts5.ObjRotx = 0:Me.TimerEnabled=0:FlashLevel1=1:FlasherFlash1_Timer:End Sub
...
NFadeLm 12, L12                   ' green 4 left up (collect bonus )   green
NFadeLm 12, L27 
...
NFadeLm 28, L28                   ' green 3 left up  ( collect bonus )   green
NFadeLm 28, L26 
...
NFadeLm 44, L44             ' green 2 left up ( ion gen )     green
NFadeLm 44, L16 
NFadeL 46, L46             '  1500  midmid  green
NFadeL 47, L47             ' 30 midleft   white
NFadeLm 60, l60           ' green left up (collect bonus)    green
NFadeLm 60, l13
...
Sub Wall_Hit (idx)
	PlaySound "glass_hit" , 0, Vol(ActiveBall), Pan(ActiveBall), 0, Pitch(ActiveBall), 0, 0
End Sub
...
GIplasleftup.Duration 1,60 ,0:GIplasrightup.Duration 1,120 ,0:Giplasright.Duration 1,180,0:Giplasslingright.Duration 1,240,0
Giplasslingleft.Duration 1,300,0:Giplasbumper.Duration 1,360,0:Giplasleft.Duration 1,420,0 
GItube.state=1
end if 
...
Dim Flashlevel1,Flashlevel2,Flashlevel4,Flashlevel5
...
Sub Trigger5_Hit() : Light1.State=1: End Sub
Sub Trigger6_Hit() : Light2.state=1:End Sub
Sub Trigger7_Hit() : Light3.state=1:End Sub
Sub Trigger8_Hit() : Light4.state=1:End Sub
Sub Trigger9_Hit() : Light5.state=1:End Sub
Sub Trigger10_Hit() : Light1.State=0:Light6.state=1:End Sub
Sub Trigger11_Hit() :Light2.State=0: Light7.state=1:End Sub
Sub Trigger12_Hit() :Light3.State=0: Light8.state=1:End Sub
Sub Trigger13_Hit() : Light4.State=0:Light9.state=1:End Sub
Sub Trigger14_Hit() : Light5.State=0: End Sub
Sub Trigger15_Hit() : Light6.State=0: End Sub
Sub Trigger16_Hit() : Light7.State=0: End Sub
Sub Trigger17_Hit() : Light8.State=0: End Sub
Sub Trigger18_Hit() : Light9.State=0: End Sub
