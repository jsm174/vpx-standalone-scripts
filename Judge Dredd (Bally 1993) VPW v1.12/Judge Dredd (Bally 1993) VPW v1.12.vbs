...
'v1.11
'Fixed the collidable corners of laneguides
'Some insert adjustements

'v1.12
'Inserts have normal maps enabled only in VRroom mode by default
...
Const CabinetMode = 1 				'0 - Rails, 1 - Hidden Rails
...
Dim NormalsForInserts : NormalsForInserts = 0	'May look odd with certain POV's in cabinetmode. Enabling for VRroom by default
if VRRoom <> 0 then NormalsForInserts = 1
