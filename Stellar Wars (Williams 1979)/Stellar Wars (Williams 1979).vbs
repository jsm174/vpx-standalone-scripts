...
Const cGameName="stlwr_l2",UseSolenoids=2,UseLamps=0,UseGI=1,SSolenoidOn="SolOn",SSolenoidOff="SolOff"

LoadVPM "01000000", "S6.VBS", 2.1
...
Sub Table1_Init
	...
	BallRelease001.CreateBall
	BallRelease001.Kick 90, 1
	BallRelease001.enabled=0

	vpmNudge.TiltSwitch=49
  	vpmNudge.Sensitivity=3
  	vpmNudge.TiltObj=Array(sw14,sw45,sw46,sw40,sw47,LeftSlingshot,RightSlingshot)
...
'               RandomSoundBallRelease sw36
	...
	for each xx in gi_inserts:xx.blenddisablelighting=7: next
...
'	If keycode = RightMagnaSave Then Flash9 true
	...
	if KeyCode = LeftTiltKey Then Nudge 90, .15:SoundNudgeLeft()
	if KeyCode = RightTiltKey Then Nudge 270, .15:SoundNudgeRight()
	if KeyCode = CenterTiltKey Then Nudge 0, .15:SoundNudgeCenter()
	...
	If keycode = LeftFlipperKey Then 
		VRFlipperButtonLeft.X = 2106.726 + 10
	End If

	If keycode = RightFlipperKey Then 
		VRFlipperButtonRight.X = 2408.126 - 10
	End If
...
Sub Table1_KeyUp(ByVal KeyCode)
	...
	If keycode = LeftFlipperKey Then 
		VRFlipperButtonLeft.X = 2106.726
	End If

	If keycode = RightFlipperKey Then 
		VRFlipperButtonRight.X = 2408.126
	End If
...
SolCallback(2) = "dropupleft"
SolCallback(3) = "saucerout"
SolCallback(4) = "dropupcenter1"
SolCallback(5) = "dropupcenter2"
SolCallback(6) = "dropupright"
SolCallback(8) = "Flash9"
...
sub Flash9(flstate)
	If Flstate Then
		...
		Sol9lvl = Sol9lvl * 0.999 'minor tweak to force faster fade
	End If
end sub
...
'	debug.print Sol9lvl
	...
	fspace1.opacity = 3850 * Sol9lvl^3
	fspace2.opacity = 3850 * Sol9lvl^3
	flasher_on.blenddisablelighting = 200 * Sol9lvl^1
...
Sub sw21_timer
		...
		Case 9:pkickarm001.rotz=0:sw21.TimerEnabled = 0: if sw21.ballcntover > 0 then SaucerOut -1
    End Select
...
Sub Sw52_Hit:DTHit 52:End Sub
Sub Sw53_Hit:DTHit 53:End Sub
...
Sub dropupright(enabled)
	if enabled then
'		PlaySoundAt SoundFX(DTResetSound,DOFContactors), psw42
		RandomSoundDropTargetReset psw32
		DTRaise 31
		DTRaise 32
		DTRaise 33
	end if
...
Sub dropupcenter1(enabled)
	if enabled then
'		PlaySoundAt SoundFX(DTResetSound,DOFContactors), cutout_prim1
		RandomSoundDropTargetReset psw50
		DTRaise 50
		DTRaise 51
	end if
End Sub

Sub dropupcenter2(enabled)
	if enabled then
'		PlaySoundAt SoundFX(DTResetSound,DOFContactors), cutout_prim1
		RandomSoundDropTargetReset psw53
		DTRaise 52
		DTRaise 53
	end if
End Sub
...
'Stand Up Targets
 Sub Tsw22_Hit: PrimStandupTgtHit 22, Tsw22, PrimT22: vpmTimer.PulseSw 22 : End Sub
 Sub Tsw22_Timer: PrimStandupTgtMove 22, Tsw22, PrimT22: End Sub
 Sub Tsw38_Hit: PrimStandupTgtHit 38, Tsw38, PrimT38: vpmTimer.PulseSw 38 : End Sub
 Sub Tsw38_Timer: PrimStandupTgtMove 38, Tsw38, PrimT38: End Sub

'Wire Triggers
Sub sw10_Hit:Controller.Switch(10) = 1:psw10.transz = -6:End Sub
Sub sw10_UnHit:Controller.Switch(10) = 0:psw10.transz = 0:End Sub
Sub sw11_Hit:Controller.Switch(11) = 1:psw11.transz = -6:End Sub
Sub sw11_UnHit:Controller.Switch(11) = 0:psw11.transz = 0:End Sub
Sub sw12_Hit:Controller.Switch(12) = 1:psw12.transz = -6:End Sub
Sub sw12_UnHit:Controller.Switch(12) = 0:psw12.transz = 0:End Sub
...
Sub sw29_Hit:Controller.Switch(29) = 1:psw29.transz = -6:End Sub
Sub sw29_UnHit:Controller.Switch(29) = 0:psw29.transz = 0:End Sub
Sub sw41_Hit:Controller.Switch(41) = 1:psw41.transz = -6:End Sub
Sub sw41_UnHit:Controller.Switch(41) = 0:psw41.transz = 0:End Sub
Sub sw42_Hit:Controller.Switch(42) = 1:psw42.transz = -6:End Sub
Sub sw42_UnHit:Controller.Switch(42) = 0:psw42.transz = 0:End Sub
Sub sw43_Hit:Controller.Switch(43) = 1:psw43.transz = -6:End Sub
Sub sw43_UnHit:Controller.Switch(43) = 0:psw43.transz = 0:End Sub
...
Sub sw40_hit
	vpmTimer.PulseSw(40)
	RandomSoundBumperTop bumperskirt004
...
Sub sw47_hit
	vpmTimer.PulseSw(47)
	RandomSoundBumperTop bumperskirt005
...
Sub InitLampsNF()
	...
	Lampz.Callback(1) = "DisableLighting p1, 10,"
...
'	Lampz.Callback(16) = "DisableLighting p16, 10,"
	...
	Lampz.MassAssign(17)= l17C
	Lampz.MassAssign(17)= l17D
	Lampz.Callback(17) = "DisableLighting p17, 10,"
	Lampz.Callback(17) = "DisableLighting p17B, 10,"
	Lampz.MassAssign(18)= l18
	Lampz.MassAssign(18)= l18B
	Lampz.Callback(18) = "DisableLighting p18, 10,"
	Lampz.MassAssign(19)= l19
	Lampz.MassAssign(19)= l19B
	Lampz.Callback(19) = "DisableLighting p19, 20,"
	...
	Lampz.Callback(23) = "DisableLighting p23, 10,"
	Lampz.MassAssign(24)= l24
	Lampz.MassAssign(24)= l24B
	Lampz.Callback(24) = "DisableLighting p24, 10,"
	...
	Lampz.MassAssign(33)= l33C
	Lampz.MassAssign(33)= l33D
	Lampz.Callback(33) = "DisableLighting p33, 10,"
	Lampz.Callback(33) = "DisableLighting p33B, 10,"
	...
	Lampz.Callback(36) = "DisableLighting p36, 10,"
	Lampz.MassAssign(37)= l37
	Lampz.MassAssign(37)= l37B
	Lampz.Callback(37) = "DisableLighting p37, 10,"
	...
	Lampz.Callback(56) = "DisableLighting render2creditlamp, 3,"
...
sub FlipperUpdate()
	...
	SpinnerRod001.TransX = sin( (sw25.CurrentAngle) * (2*PI/360)) * 12
	SpinnerRod001.TransZ = sin( (sw25.CurrentAngle+90) * (2*PI/360)) * 3.5
...
RubbersD.addpoint 0, 0, 1.175        'point# (keep sequential), ballspeed, CoR (elasticity)
...
dim DT16,DT17,DT18,DT31,DT32,DT33,DT50,DT51,DT52,DT53
'
...
Dim DTArray
DTArray = Array(DT16,DT17,DT18,DT31,DT32,DT33,DT50,DT51,DT52,DT53)
...
Sub DTAnim_Timer()
	DoDTAnim
	if controller.Switch(16) and controller.Switch(17) and controller.Switch(18) Then
		controller.Switch(19) = 1
	Else 
		controller.Switch(19) = 0
	end if
	if controller.Switch(31) and controller.Switch(32) and controller.Switch(33) Then
		controller.Switch(34) = 1
	Else 
		controller.Switch(34) = 0
	end if
	if controller.Switch(50) and controller.Switch(51) and controller.Switch(52) and controller.Switch(53) Then
...
'******************************************************
'*******	Set Up Backglass Flashers in VR	*******
'******************************************************
...
Sub SetBackglass()
	...
	For Each obj In VRBackglassFlash
		obj.x = obj.x
		obj.height = - obj.y
		obj.y = 77 'adjusts the distance from the backglass towards the user
	Next
...
Sub UpdateMultipleLamps()
	...
	If Controller.Lamp(2) = 0 Then: bgf2.visible=0: else: bgf2.visible=1 	' "S"
	If Controller.Lamp(3) = 0 Then: bgf3.visible=0: else: bgf3.visible=1 	' "T"
	If Controller.Lamp(4) = 0 Then: bgf4.visible=0: else: bgf4.visible=1 	' "E"
	If Controller.Lamp(5) = 0 Then: bgf5.visible=0: else: bgf5.visible=1 	' "L"
	If Controller.Lamp(6) = 0 Then: bgf6.visible=0: else: bgf6.visible=1 	' "L"
	If Controller.Lamp(7) = 0 Then: bgf7.visible=0: else: bgf7.visible=1 	' "A"
	If Controller.Lamp(8) = 0 Then: bgf8.visible=0: else: bgf8.visible=1 	' "R"
	If Controller.Lamp(9) = 0 Then: bgf9.visible=0: else: bgf9.visible=1 	' "W"
	If Controller.Lamp(10) = 0 Then: bgf10.visible=0: else: bgf10.visible=1 ' "A"
	If Controller.Lamp(11) = 0 Then: bgf11.visible=0: else: bgf11.visible=1 ' "R"
	If Controller.Lamp(12) = 0 Then: bgf12.visible=0: else: bgf12.visible=1 ' "S"
