...
Const B2SOn = 1 'Activate The DirectB2S / DOF system.
Const DOFs = True 'Activate this to mute mech sounds for DOF
'-------------------------------------------------
...
Const DMD_Plastic = 1 'Render a plastic cover over the DMD display.
...
Const dmdcolor = 0 'Set the color of the NORMAL Integrated DMD - '0 = Orange / 1 = Green / 2 = Red / 3 = Pink / 4 = Blue / 5 Cyan / 6 Purple / 7 Yellow

'-------------------------------------------------

Const DMD_Rot = 1 'Rotate the Standard DMD - 1 = Rotate/ 0 = Normal
...
Dim Sound1, Sound2, Sound3, Sound4, Sound5, B2SController, Neon_Licht
...
Lights(63)=array (L63,L63a)
Lights(64)=array (L64,L64a)
Lights(65)=array (L65,L65a)
Lights(66)=array (L66,L66a)
Lights(67)=array (L67,L67a)
Lights(68)=array (L68,L68a)

Lights(71)=array (L71,L71a)
Lights(72)=array (L72,L72a)
Lights(73)=array (L73,L73a)
Lights(74)=array (l74,L74a,l74a1)
Lights(75)=array (l75,L75a,l75a1)
Lights(76)=array (L76,L76a)
...
Sub table1_KeyDown(ByVal Keycode)
    If keycode = PlungerKey Then Plunger2.Pullback:PlaySound "PlungerPull"
    If keycode = LeftTiltKey Then Nudge 90, 5:PlaySound "fx_nudge_left"
    If keycode = RightTiltKey Then Nudge 270, 5:PlaySound "fx_nudge_right"
    If keycode = CenterTiltKey Then Nudge 0, 6:PlaySound "fx_nudge_forward"
    If keycode = RightMagnaSave Then Cycle_Neons
    If keycode = 6 Then Neon_Hell
    If keycode = 5 Then Neon_Dunkel
    If vpmKeyDown(keycode) Then Exit Sub
End Sub

Sub table1_KeyUp(ByVal Keycode)
	If keycode = PlungerKey Then Plunger2.Fire:PlaySound "plunger"
...
'************* Hanibal Bumper Lights added **********'

Sub Bumper1_Hit:vpmTimer.PulseSw 53:PlaySound "bumper2" , 0, (15+5*Rnd), 0.09, 0.15 :Me.TimerEnabled = 1:Me.timerinterval = 10: B1.State = 1 :End Sub

Sub Bumper2_Hit:vpmTimer.PulseSw 55:PlaySound "bumper2" , 0, (15+5*Rnd), 0.07, 0.15:Me.TimerEnabled = 1:Me.timerinterval = 10: B2.State = 1 :End Sub

Sub Lbumper1_Hit():vpmTimer.PulseSw 54:PlaySound "bumper2", 0, (15+5*Rnd), 0.05, 0.15: Me.TimerEnabled = 1:Me.timerinterval = 10: B3.State = 1:boom2_shake.enabled = 1:End Sub
...
'Spinner
Sub sw117_Spin():vpmTimer.PulseSw 117:PlaySound "fx_spinner":End Sub
Sub sw115_Spin():vpmTimer.PulseSw 115:PlaySound "fx_spinner":End Sub
...
Sub sw26_Hit:Controller.Switch(26) = 1:pstep = 1:cplas.enabled = 1:d2dir = 1:d2timer.enabled = 1:PlaySound "fx_sensor":End Sub
Sub sw26_Unhit:Controller.Switch(26) = 0:d2dir = 2:d2timer.enabled = 1:End Sub

Sub sw17_Hit:Controller.Switch(17) = 1:pstep = 1:cplas.enabled = 1:d4dir = 1:d4timer.enabled = 1:PlaySound "fx_sensor":End Sub
Sub sw17_Unhit:Controller.Switch(17) = 0:d4dir = 2:d4timer.enabled = 1:End Sub

Sub sw75_Hit:Controller.Switch(75) = 1:pstep = 1:cplas.enabled = 1:d3dir = 1:d3timer.enabled = 3:PlaySound "fx_sensor":End Sub
Sub sw75_Unhit:Controller.Switch(75) = 0:d3dir = 2:d3timer.enabled = 1:End Sub

Sub sw76_Hit:Controller.Switch(76) = 1:pstep = 1:cplas.enabled = 1:d1dir = 1:d1timer.enabled = 1:PlaySound "fx_sensor":End Sub
...
Sub sw45_Hit:Controller.Switch(45) = 1:PlaySound "fx_sensor":DOF 245, 2:End Sub
...
Sub sw65_Hit:Controller.Switch(65) = 1:PlaySound "fx_sensor":Flipper2.rotatetoend:End Sub
...
Sub sw18_Hit:Controller.Switch(18) = 1:DOF 218, 1: Plungerlight.State = 1 : End Sub
Sub sw18_Unhit:Controller.Switch(18) = 0:DOF 218, 0:Plungerlight.State = 0 :End Sub
...
Sub sw41_Hit:vpmTimer.PulseSw 41:PlaySound "target":DOF 241, 2:End Sub
Sub sw61_Hit:vpmTimer.PulseSw 61:PlaySound "target":DOF 281, 2:End Sub
Sub sw62_Hit:vpmTimer.PulseSw 62:PlaySound "target":DOF 282, 2:End Sub
Sub sw56_Hit:vpmTimer.PulseSw 56:PlaySound "target":DOF 284, 2:End Sub
Sub sw58_Hit:vpmTimer.PulseSw 58:PlaySound "target":DOF 283, 2:End Sub
Sub sw38_Hit:vpmTimer.PulseSw 38:PlaySound "target":DOF 285, 2:End Sub
Sub sw38a_Hit:vpmTimer.PulseSw 38:PlaySound "target":DOF 286, 2:End Sub
Sub sw37_Hit:vpmTimer.PulseSw 37:PlaySound "target":DOF 287, 2:End Sub
Sub sw37b_Hit:vpmTimer.PulseSw 37:PlaySound "target":DOF 288, 2:End Sub
Sub sw37d_Hit:vpmTimer.PulseSw 37:PlaySound "target":DOF 289, 2:End Sub

Sub sw74_Hit:vpmTimer.PulseSw 74:PlaySound "target":DOF 274, 2:End Sub
...
Sub BallSound(dummy):PlaySound "Ball_Bounce":End Sub
...
If enabled Then
DOF 263,1
PlaySound "Slingshot-Sound-2" , 0, (15+5*Rnd), -0.05, 0.15
Else
DOF 263,0
End If
End Sub
...
'___________________Bumper Special



'Sub Sol53(enabled)	' Upper Bumper 
'If enabled Then
'B1.State = 1
'Else
'B1.State = 0
...
'Sub Sol54(enabled) 		' Middle Bumper 
'If enabled Then
'B3.State = 1
'Else
'B3.State = 0
...
'Sub Sol55(enabled) 		' Lower Bumper 
'If enabled Then
'B2.State = 1
'Else
'B2.State = 0
...
Sub SolLFlipper(Enabled)
     ...
     If Enabled Then
		 PlaySound "Flipper-oben-Links"
		 LeftFlipper.RotateToEnd
         DOF 250,1
     Else
		 LFTCount=1
		 PlaySound "Flipper-unten-Links"
...
Sub SolRFlipper(Enabled)
     ...
     If Enabled Then
		 PlaySound "Flipper-oben-Rechts"
		 RightFlipper.RotateToEnd
         DOF 251,1
     Else
		 RFTCount=1
		 PlaySound "Flipper-unten-Rechts"
...
End Sub
	...
	if AP = True and Zeit < 50 then Plunger2.Pullback : Zeit = Zeit +10
	if AP = False and Zeit > 0 then Plunger2.Fire : Zeit = 0
...
' *********************
 ...
 Sub SolRingmasterMagnet(Enabled)
    ...
    If Not Enabled And RMBallInMagnet Then
		...
		cball.vely = cball.vely + dcos(KickAngle)*(2 +Rnd)
		cball.velx = cball.velx - dsin(KickAngle)*(2 +Rnd)
		PlaySound "Han-Feder", 0, (cball.vely + cball.velx), 0, 0.15 'Spring Sound
...
'*************  RM Shake Scripting modyfied by Hanibal *************
 Dim mMagnet, cBall, pMod, rmmod

 Set mMagnet = new cvpmMagnet
 With mMagnet
	.InitMagnet WobbleMagnet, 2 '1.5
	.Size = 100
...
'Includes stripped down version of my reverse slope scripting for a single ball
 ...
 Sub aWobbleTimer_Timer
    ...
    If RMCurrPos >3 Then
	PlaySound "Han-Feder", 0, (((ringmaster.rotx * 2)  + (ringmaster.roty * 2))/100), (ringmaster.rotx / 1000), ((ringmaster.rotx + ringmaster.roty)/2000) 'Hanibal Spring Sound 
    End If
 End Sub

 Sub BallShake_Timer
	If Not IsEmpty(RMMagBall) Then
		RMMagBall.y = RMMagnetkicker.y - dsin(ringmaster.rotx)*265.5*(3 + RND) 'modify Ball movement
		RMMagBall.x = RMMagnetkicker.x + dsin(ringmaster.roty)*265.5*(3 + RND) 'modify Ball movement
	End If
 End Sub
...
Sub SubwayHandler(aKick, aSwNo)
    'ClearballID
    aKick.Destroyball:PlaySound "RM_Lip":PlaySound "subway2"
...
Sub RollingTimer_Timer()
    ...
    For b = 0 to UBound(BOT)
        If BallVel(BOT(b) ) > 1 AND RMBallInMagnet = 0 Then 'AND BOT(b).z < 30 
            If BOT(b).z > 30 Then
            Rampy = 2
            Else
			Rampy = 1
...
Sub OnBallBallCollision(ball1, ball2, velocity)
	PlaySound("fx_collide"), 0, Csng(velocity) ^2 / 200, Pan(ball1), 0, Pitch(ball1), 1, 0
    If ball1.id = 666 OR ball2.id = 666 Then
    PlaySound("rubber_hit_3"), 0, Csng(velocity) ^2 / 200, Pan(ball1), 0, Pitch(ball1), 1, 0
    else
...
Sub Trigger2_Hit()
	PlaySound "fx_metalrolling2", 0, 10, 0, 0.15
End Sub

Sub Trigger3_Hit()
	PlaySound "fx_collide", 0, 10, 0, 0.15
End Sub
...
' ******Hanibals Random Neon Lights Script
Light12.Intensity = (Neon_Licht+((1+(Neon_Licht/4))*Rnd))
Light16.Intensity = (Neon_Licht+((1+(Neon_Licht/4))*Rnd))
Light17.Intensity = (Neon_Licht+((1+(Neon_Licht/4))*Rnd))
Light18.Intensity = (Neon_Licht+((1+(Neon_Licht/4))*Rnd))
Light19.Intensity = (Neon_Licht+((1+(Neon_Licht/4))*Rnd))
Light20.Intensity = (Neon_Licht+((1+(Neon_Licht/4))*Rnd))
Light21.Intensity = (Neon_Licht+((1+(Neon_Licht/4))*Rnd))
Light22.Intensity = (Neon_Licht+((1+(Neon_Licht/4))*Rnd))
Light23.Intensity = (Neon_Licht+((1+(Neon_Licht/4))*Rnd))
Light24.Intensity = (Neon_Licht+((1+(Neon_Licht/4))*Rnd))
Light25.Intensity = (Neon_Licht+((1+(Neon_Licht/4))*Rnd))
Light26.Intensity = (Neon_Licht+((1+(Neon_Licht/4))*Rnd))
Light27.Intensity = (Neon_Licht+((1+(Neon_Licht/4))*Rnd))
Light44.Intensity = (Neon_Licht+((1+(Neon_Licht/4))*Rnd))
Light93.Intensity = (Neon_Licht+((1+(Neon_Licht/4))*Rnd))
Light94.Intensity = (Neon_Licht+((1+(Neon_Licht/4))*Rnd))
Light95.Intensity = (Neon_Licht+((1+(Neon_Licht/4))*Rnd))
Light96.Intensity = (Neon_Licht+((1+(Neon_Licht/4))*Rnd))
Light97.Intensity = (Neon_Licht+((1+(Neon_Licht/4))*Rnd))
Light98.Intensity = (Neon_Licht+((1+(Neon_Licht/4))*Rnd))
Light99.Intensity = (Neon_Licht+((1+(Neon_Licht/4))*Rnd))
Light124.Intensity = (Neon_Licht+((1+(Neon_Licht/4))*Rnd))
Light125.Intensity = (Neon_Licht+((1+(Neon_Licht/4))*Rnd))
Neon_On.Intensity = (Neon_Licht+((4+(Neon_Licht))*Rnd))

 End Sub

Sub Neon_Hell
If Neon_Licht < 50 Then
Neon_Licht = Neon_Licht +0.5
End If
End Sub

Sub Neon_Dunkel
If Neon_Licht > 0 Then
Neon_Licht = Neon_Licht -0.5
End If
End Sub
...
' Physics tests by Hanibal

Sub Physik
Table1.playfield_friction = (0.0020+(0.001*Rnd))
