...
Const cGameName = "MrEvil_1979"
Const TableName = "MrEvil_1979"
...
'	End If
	...
	StarCount = 0
	FPlays = 0
	RBankDown = 0           'pone a cero el numero de veces que las 
	LBankDown = 0 			'dianas han sido abatidas
...
Sub RightSlingShot_Timer
    Select Case RStep
		Case 1:RSLing4.Visible = 0:RSLing3.Visible = 1:sling1.rotx = 14
        Case 2:RSLing3.Visible = 0:RSLing2.Visible = 1:sling1.rotx = 2
        Case 3:RSLing2.Visible = 0:sling1.rotx = -10:RightSlingShot.TimerEnabled = 0:gi1.State = 1:Gi2.State = 1
    End Select
    RStep = RStep + 1
End Sub
...
Sub LeftSlingShot_Timer
    Select Case LStep
		Case 1:LSLing4.Visible = 0:LSLing3.Visible = 1:sling2.rotx = 14
        Case 2:LSLing3.Visible = 0:LSLing2.Visible = 1:sling2.rotx = 2
        Case 3:LSLing2.Visible = 0:sling2.rotx = -10:LeftSlingShot.TimerEnabled = 0:gi3.State = 1:Gi4.State = 1
    End Select
    LStep = LStep + 1
End Sub
...
'debug.print BankDown
        DTLSecL
        vpmtimer.addtimer 1000, "DTdrop 1 '"
    End If
End Sub
...
Sub DTRSecR
	Select Case RBankDown
		Case 0:LiCap2.State = 0 :LiPS3EB.State=0
		Case 1:vpmtimer.addtimer 1000, "LiCap2.State = 1 :LiPS3EB.State=1 '"		
        Case 2:vpmtimer.addtimer 1000, "LiCap2.State = 0 :LiCapDB.state = 1 :LiPS3EB.State=0'"
        Case 3:RBankDown=2
	End Select
End Sub
...
Sub DTLSecL
	 Select Case LBankDown
		Case 0:LiCap1.State =0 :LiCapEB.state =0 :LiCapSP.state =0
		Case 1:LiCap1.State = 1 :LiPS1DB.State=1 :LiDBH.State=1
        Case 2:LiCapEB.state = 1 :LiPS1DB.State=0 :LiDBH.State=0 :LiCap1.State=0 ':LiPS3EB.State=1
		Case 3:LiCapEB.state = 0 :LiCapSP.state = 1 ':LiPS3EB.state=0
        Case 4:LBankDown =3 		'IF LiCapSP.state = 1 Then LBankDown =0:LiCapSP.state =0
     End Select
End Sub
...
Sub CaptiveSw2_Hit
    ...
    Select Case LBankDown
			...
			Case 3:AwardSpecial :LBankDown=0 :LiCapSP.state = 0
            Case Else
                AddScore 0
        End Select
End Sub
...
Sub TargetCaptive_Hit
    ...
    Select Case RBankDown
			Case 0:AddScore 0 
            Case 1:AddScore 50000
            Case 2:DoubleBonus = 2 : LiCapDB.State=0 : LiDB.State=1 :RBankDown=0
            Case Else
                AddScore 0
        End Select
End Sub
...
'    ChangeToBumper1Lights
	RBankDown = 0           'pone a cero el numero de veces que las dianas han sido abatidas
	LBankDown = 0 
End Sub
...
'	LBankDown = 0 
	...
	DTdrop 1				'sube las dianas de la izquierda y derecha
