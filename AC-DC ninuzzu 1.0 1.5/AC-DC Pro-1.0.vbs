...
Sub ACDC_Init
    ...
    With Controller
        .GameName = cGameName
        .SplashInfoLine = "AC/DC Pro (Stern 2012)"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
...
'Other Suff
	InitOptions:InitCannon:InitDiverters
...
'Target Bell
Sub Sw36_Hit():vpmTimer.PulseSw 36: PlaySoundAtBallVol SoundFX("fx_target",DOFTargets),2: End Sub
