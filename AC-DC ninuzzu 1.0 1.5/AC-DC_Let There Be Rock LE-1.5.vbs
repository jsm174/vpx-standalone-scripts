...
Const InstrCardType = 0				'Instruction Cards Type (0= white, 1= yellow, 2 = custom)
...
Sub ACDC_Init
    ...
    With Controller
        .GameName = cGameName
        .SplashInfoLine = "AC/DC Let There Be Rock LE (Stern 2012)"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
...
l63b.colorfull = RGB(255*LampState(59),255*LampState(60),255*LampState(61))
l63c.colorfull = RGB(255*LampState(59),255*LampState(60),255*LampState(61))
If LampState(59) OR LampState(60) OR LampState(61) Then l63.state=1:l63a.state=1:l63b.state=1:l63c.state=1:Else l63.state=0:l63a.state=0:l63b.state=0:l63c.state=0:End If
...
Sub UpdateGIs
	...
	bulb2.BlendDisableLighting = 8*LampState (130)/50
	bulb4.BlendDisableLighting = 8*LampState (130)/50
	bulb6.BlendDisableLighting = 8*LampState (130)/50
	MaterialColor "TrainRed", RGB(255*LampState (130)/50,255*LampState (130)/50, 255*LampState (130)/50)
	'132 gi blue
	...
	bulb1.BlendDisableLighting = 8*LampState (132)/50
	bulb3.BlendDisableLighting = 8*LampState (132)/50
	bulb5.BlendDisableLighting = 8*LampState (132)/50
	bulb7.BlendDisableLighting = 8*LampState (132)/50
	MaterialColor "TrainBlue", RGB(255*LampState (132)/50,255*LampState (132)/50, 255*LampState (132)/50)
	'134 gi low pf
