...
Const cGameName = "Streets of Rage"
...
Const TableName = "Streets of Rage"
...
Sub InstantInfo
 ...
 '   DMD "black.jpg", "BAD GUYS KILLED", Monsters(CurrentPlayer), 800
End Sub
...
Sub ResetForNewGame()
   ...
   DisplayB2SText "           STREETS OF RAGE           "
   D1.Text = "           STREETS OF RAGE           "
...
Sub DMD_Init
    ...
    DMD "", "STREETS OF RAGE", "ROM VERS " &myVersion, 2000
End Sub
...
Sub ShowTableInfo
    ...
    DMD "", "IVANTBA", "PRESENTS", 3000
    DMD "", "", " STREETS OF RAGE ", 3000
    ' Highscores
	...
	If POWBonusCount = 0 Then
		Select Case POWBonusTimer.Uservalue
			Case 12:
				...
				D1.Text = "          NO SOR BONUS          "', seScrollIn, 1000, 0, TRUE
                DisplayB2SText "          NO SOR BONUS          "
			Case 14:
				Playsound "cmonboy"
			Case 22:
				'D1.FlushQueue()
...
Sub FinalMissionShowTimer_Timer()
	...
	Select Case FinalMissionShowTimer.Uservalue
		...
		Case 2:
			...
			Kicker4SolenoidPulse()
		Case 3:
            DisplayB2SText "      SOR BONUS IS DOUBLED      "
			D1.Text = "      SOR BONUS IS DOUBLED      "
			Playsound "thankyou"
		Case 4:
		...
		Case 5:
			...
			Playsound "ok"
		Case 6:
            DisplayB2SText "       KICK BUMPERS ARE LIT      "
			D1.Text = "       KICK BUMPERS ARE LIT      "
		...
		Case 13:
			...
			Playsound "steel"
		Case 14:
            DisplayB2SText "     AXEL, BLAZE                "
			D1.Text = "     AXEL, BLAZE                "
			Playsound "steel"
		Case 15:
            DisplayB2SText "     AXEL, BLAZE MAX            "
			D1.Text = "     AXEL, BLAZE MAX            "
			Playsound "steel"
		Case 16:
            DisplayB2SText "     AXEL, BLAZE MAX & SKATE      "
			D1.Text = "     AXEL, BLAZE MAX & SKATE      "
			Playsound "steel"
		Case 17:
...
Sub AttractMessagesTimer_Timer()
	...
	Select Case AttractMessagesTimerUserData
		...
		Case 2:
			D1.Text = "    IVANTBA PRESENTS     "
            DisplayB2SText "    IVANTBA PRESENTS     "
		Case 3:
			'D1.FlushQueue()
			'D2.FlushQueue()
			D1.Text = "           STREETS OF RAGE           "', seScrollIn, 1000, 0, TRUE
            DisplayB2SText "           STREETS OF RAGE           "
		Case 4:
			D1.Text = "       BY IVANTBA        "
            DisplayB2SText "       BY IVANTBA        "
		Case 5:
		...
		Case 9:
			D1.Text = "    THE STREETS OF RAGE DATABASE     "
            DisplayB2SText "    THE STREETS OF RAGE DATABASE     "
		Case 10:
			D1.Text = " YUZO KOSHIRO   "
            DisplayB2SText " YUZO KOSHIRO   "
		Case 11:
			D1.Text = " COLLECT WEAPONS FOR EXTRA BALL "
            DisplayB2SText " COLLECT WEAPONS FOR EXTRA BALL "
		Case 12:
			D1.Text = "     COLLECT SOR FOR BONUS      "
            DisplayB2SText "     COLLECT SOR FOR BONUS      "
		Case 13:
			D1.Text = " SHOOT KICKERS TO START MISSION "
            DisplayB2SText " SHOOT KICKERS TO START MISSION "
		Case 14:
			D1.Text = "COMPLETE STREETRAGE TO LIGHT LOCK"
            DisplayB2SText "COMPLETE STREETRAGE TO LIGHT LOCK"
		Case 15:
...
'	D1.FlushQueue()
'	D2.FlushQueue()
    DisplayB2SText "         * SOR SAVED *          "
	D1.Text = "         * SOR SAVED *          "
'	D1.QueueText "           SOR SAVED            ", seBlinkMask, 300
'	D2.QueueText "           SOR SAVED            ", seBlinkMask, 300
	AddScore(15000)
	Playsound "thankyou"
	Playsound "chopper"
...
Sub ShowNextMessage()
	...
	If Not(bInterruptedDisplay) Then
		Select Case NextMessage
			...
			Case 6:
				' Starting mission 3.
				D1.Text =  "        SUPER KICK BUMPERS       "', seScrollUp, 2000, 0, TRUE
				DisplayB2SText  "        SUPER KICK BUMPERS       "', seScrollUp, 2000, 0, TRUE
			Case 7:
				' Starting mission 4.
				D1.Text =  "SHOOT CAPTIVE BALL OR SOR LANES "', seScrollUp, 2000, 0, TRUE
				DisplayB2SText  "SHOOT CAPTIVE BALL OR SOR LANES "', seScrollUp, 2000, 0, TRUE
			Case 8:
				' Starting mission 5.
				D1.Text =  "      DEFEAT BIG BOSS       "', seScrollUp, 2000, 0, TRUE
				DisplayB2SText  "      DEFEAT BIG BOSS       "', seScrollUp, 2000, 0, TRUE
			Case 9:
