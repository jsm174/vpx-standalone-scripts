...
'⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
'                          VISUAL PINBALL X
'			  Fully re-themed from the table Mago de Oz by JPSalas
'			   With influences from Pedroperes' Monsters of Rock
...
'                  Including JP's Arcade Physics 4.0.0
' ***************************************************************************
...
Const BallMass = 1      ' standard ball mass in JP's VPX Physics 4.0
...
Sub SolLFlipper(Enabled)
    ...
    Else
        ...
        LeftFlipper1.EOSTorque = 0.1:LeftFlipper1.RotateToStart
    End If
End Sub
...
Sub SolRFlipper(Enabled)
    ...
    Else
        ...
        RightFlipper1.EOSTorque = 0.1:RightFlipper1.RotateToStart
    End If
End Sub
...
Sub CheckTilt                                  'Called when table is nudged
    ...
    If(Tilt> TiltSensitivity)AND(Tilt <15)Then 'show a warning
        DMD "_", CL(1, "CAREFUL!"), "", eNone, eBlinkFast, eNone, 1000, True, "vo_dontshakethegame"
    End if
...
Sub PLaySelectedSong
    Select Case Songnr
        ...
        Case 14:PlaySong "mu_15"
        Case 15:PlaySong "mu_16"
    End Select
End Sub
...
Sub SelectSong(keycode)
    ...
    If keycode = LeftFlipperKey Then
        Songnr = (Songnr - 1)
        If Songnr <0 Then Songnr = 15
        UpdateDMDSong
    End If
    If keycode = RightFlipperKey Then
        Songnr = (Songnr + 1)MOD 16
        UpdateDMDSong
    End If
End Sub
...
Sub UpdateDMDSong() 'Updates the DMD with the chosen song
    DMDFlush
    Select Case Songnr
        Case 0:DMD "", "", "Track0", eNone, eNone, eNone, 4000, True, ""
        Case 1:DMD "", "", "Track1", eNone, eNone, eNone, 4000, True, ""
        Case 2:DMD "", "", "Track2", eNone, eNone, eNone, 4000, True, ""
        Case 3:DMD "", "", "Track3", eNone, eNone, eNone, 4000, True, ""
        Case 4:DMD "", "", "Track4", eNone, eNone, eNone, 4000, True, ""
        Case 5:DMD "", "", "Track5", eNone, eNone, eNone, 4000, True, ""
        Case 6:DMD "", "", "Track6", eNone, eNone, eNone, 4000, True, ""
        Case 7:DMD "", "", "Track7", eNone, eNone, eNone, 4000, True, ""
        Case 8:DMD "", "", "Track8", eNone, eNone, eNone, 4000, True, ""
        Case 9:DMD "", "", "Track9", eNone, eNone, eNone, 4000, True, ""
        Case 10:DMD "", "", "Track10", eNone, eNone, eNone, 4000, True, ""
        Case 11:DMD "", "", "Track11", eNone, eNone, eNone, 4000, True, ""
        Case 12:DMD "", "", "Track12", eNone, eNone, eNone, 4000, True, ""
        Case 13:DMD "", "", "Track13", eNone, eNone, eNone, 4000, True, ""
        Case 14:DMD "", "", "Track14", eNone, eNone, eNone, 4000, True, ""
        Case 15:DMD "", "", "brujas", eNone, eNone, eNone, 4000, True, "vo_lovethissong"
    End Select
    PLaySelectedSong
End Sub
...
Sub EndOfBall()
    ...
    If NOT Tilted Then
        ...
        DMD CL(0, "BONUS COUNT"), "", "", eNone, eNone, eNone, 1000, True, ""

        'Switch Bonus
        AwardPoints = SwitchBonusCount * 3500
        TotalBonus = AwardPoints
        DMD CL(0, "ATTACKS X " & SwitchBonusCount), CL(1, FormatScore(AwardPoints)), "", eNone, eNone, eNone, 1000, True, ""

        'Ilussia letters
        AwardPoints = IlussiaBonusCount * 25000
        TotalBonus = TotalBonus + AwardPoints
        DMD CL(0, "WARRIOR LETTERS X " & IlussiaBonusCount), CL(1, FormatScore(AwardPoints)), "", eNone, eNone, eNone, 1000, True, ""
        ...
        TotalBonus = TotalBonus + AwardPoints
        DMD CL(0, "ODM LOOPS X " & LoopsBonusCount), CL(1, FormatScore(AwardPoints)), "", eNone, eNone, eNone, 1000, True, ""

        'Pyramid awards completed
        AwardPoints = PyramidBonusCount * 75000
        TotalBonus = TotalBonus + AwardPoints
        DMD CL(0, "SCOUTED X " & PyramidBonusCount), CL(1, FormatScore(AwardPoints)), "", eNone, eNone, eNone, 1000, True, ""

        'Mancha Xanandra completed
        AwardPoints = ManchaXBonusCount * 250000
        TotalBonus = TotalBonus + AwardPoints
        DMD CL(0, "SHINZO WO SASAGEYO " & ManchaXBonusCount), CL(1, FormatScore(AwardPoints)), "", eNone, eNone, eNone, 1000, True, ""
    ...
    Else
        ...
        If PlayersPlayingGame> 1 Then
            Select Case CurrentPlayer
                Case 1:DMD "", "", "player1", eNone, eNone, eNone, 1250, True, "vo_player1"
                Case 2:DMD "", "", "player2", eNone, eNone, eNone, 1250, True, "vo_player2"
                Case 3:DMD "", "", "player3", eNone, eNone, eNone, 1250, True, "vo_player3"
                Case 4:DMD "", "", "player4", eNone, eNone, eNone, 1250, True, "vo_player4"
            End Select
        Else
            DMD "", "", "player1", eNone, eNone, eNone, 1250, True, "vo_youareup"
        End If
    End If
End Sub
...
Sub Drain_Hit()
    ...
    If(bGameInPLay = True)AND(Tilted = False)Then
        ...
        If(bBallSaverActive = True)Then
            ...
            DMD "_", CL(1, "BALL SAVED"), "", eNone, eBlinkfast, eNone, 800, True, "vo_playagain"
        Else
...
Sub swPlungerRest_Timer
    ...
    tmp = INT(RND * 4)
    Select case tmp
        case 0: PlaySound "vo_punchtheball"
        case 1: PlaySound "vo_itsgotime"
        case 2: PlaySound "vo_letsball"
        case 3: PlaySound "vo_showwhatyougot"
    End Select
End Sub
...
Sub AwardJackpot() 'award a normal jackpot,
    ...
    tmp = INT(RND * 2)
    Select Case tmp
        Case 0:DMD "", "", "jackpot", eNone, eNone, eBlink, 1500, True, "vo_jackpot"
        Case 1:DMD "", "", "jackpot", eNone, eNone, eBlink, 1500, True, "vo_jackpot2"
    End Select
...
Sub AwardSkillshot()
    ...
    'show dmd animation
    DMD "", "", "skillshot", eNone, eNone, eBlink, 1500, True, "skillshot"
    DOF 127, DOFPulse
...
Sub AwardSuperSkillshot()
    ResetSkillShotTimer_Timer
    'show dmd animation
    DMD CL(0, FormatScore(SuperSkillshotValue(CurrentPlayer))), CL(1, ("SUPER SKILLSHOT")), "", eBlinkFast, eNone, eNone, 1500, True, "superskillshot"
    DOF 127, DOFPulse
...
Sub AwardSecretSkillshot(points)
    ResetSkillShotTimer_Timer
    'show dmd animation
    DMD CL(0, FormatScore(points)), CL(1, ("SECRET SKILLSHOT")), "", eBlinkFast, eNone, eNone, 1500, True, "secretskillshot"
    DOF 127, DOFPulse
    Addscore points
    'do some light show
    GiEffect 2
    ...
    if(dqHead = dqTail)Then
        ...
        ELSE
            Select Case Mode(CurrentPlayer, 0)
                Case 1:tmp1 = "  WARRIOR MULTIBALL"
                Case 2:tmp1 = "  BASEMENT MULTIBALL"
                Case 3:tmp1 = "   SCOUT MULTIBALL"
                Case 4:tmp1 = "   ARMORED TITAN"
                Case 5:tmp1 = "   COLOSSAL TITAN"
                Case 6:tmp1 = "    ATTACK TITAN"
                Case 7:tmp1 = "    BEAST TITAN"
                Case 8:tmp1 = "    FEMALE TITAN"
                Case 9:tmp1 = "  SHINZO WO SASAGEYO"
                Case 10:tmp1 = "  COLLECT LETTERS"
                Case 11:tmp1 = "    LEVI SQUAD"
                Case 12:tmp1 = "  FOUNDING TITAN"
            End Select
            tmp2 = ""
        End If
    End If
...
Sub InstantInfo
    ...
    DMD CL(0, "SCOUT JACKPOT"), CL(1, FinisterraSJPValue(Currentplayer)), "", eNone, eNone, eNone, 800, False, ""
    tmp = FormatScore(SuperPyramidValue) & " X " & SuperPyramidMultiplier
    DMD CL(0, "SPR SCOUT VALUE"), CL(1, tmp), "", eNone, eNone, eNone, 800, False, ""
...
Sub Trigger008_Hit 'Left ramp done
    ...
    Select Case Mode(CurrentPlayer, 0)
        ...
        Case 4
            If Light054.State Then
                DMD " ARMORED TITAN COMBO", CL(1, FormatScore(CelticValue) & " X " & CelticMultiplier), "", eNone, eBlink, eNone, 1500, True, ""
                light054.State = 0
                light053.State = 2
            ...
            Else
                DMD "ARMORED TITAN RAMPSHOT", CL(1, FormatScore(CelticValue)), "", eNone, eBlink, eNone, 1500, True, ""
    ...
    Select Case Mode(CurrentPlayer, 0)
        ...
        Case 4
            If Light053.State Then
                ...
                CelticCombo.Enabled = 1
            Else
                DMD "ARMORED TITAN RAMPSHOT", CL(1, FormatScore(CelticValue)), "", eNone, eBlink, eNone, 1500, True, "vo_nicerampshot"
                AddScore CelticValue
                CelticValue = CelticValue + 150000
            End If
        Case 5
...
Sub AddBrujaLetter(n)
    ...
    if(BrujaLetter(CurrentPlayer) + n <= 5)then
        ...
        DMD "_", "   LETTER AWARDED", "", eNone, eBlink, eNone, 1500, True, "Fanfare4"
...
Sub WinAtlantia
    ...
    DMD "  BEAST TITAN DEFEATED", CL(1, FormatScore(tmp)), "", eNone, eBlink, eNone, 1500, True, "fanfare3"
    Addscore tmp
    StopAtlantia
    ResetBRUJALetter
    StartBRUJALEtter
...
Sub ArbolesTimer1_Timer 'countdown JP value
    ...
    DMD "  SHOOT THE BEAST", CL(1, FormatScore(ArbolesJPValue)), "", eNone, eNone, eNone, 200, True, ""
...
Sub CheckFolkCount
    ...
    Select Case FolkCount
        Case 1:DMD "_", "DEFEATED " &FolkCount& " TITAN", "", eNone, eBlink, eNone, 1500, True, ""
        Case 2, 3:DMD "_", "DEFEATED " &FolkCount& " TITANS", "", eNone, eBlink, eNone, 1500, True, ""
        Case 4:DMD "_", "DEFEATED " &FolkCount& " TITANS", "", eNone, eBlink, eNone, 1500, True, ""
            For X = 0 to 7
            ...
            bAddaBallActivated = True
            Light046.State = 2
        Case 5:DMD "_", "SHOOT BEAST TARGET", "", eNone, eBlink, eNone, 1500, True, ""
            Light054.State = 0
            Light053.State = 0
            Light057.State = 2
        Case 6:
            If LastSwitchHit = "bruja_target" Then
                DMD "_", CL(1, "CAPTURED 1 TITAN"), "", eNone, eBlink, eNone, 1500, True, ""
                Light057.State = 0
                Light054.State = 2
                Light053.State = 2
            Else
            ...
            bAddaBallActivated = True
            Light046.State = 2
        Case 7:DMD "_", "SHOOT BEAST TARGET", "", eNone, eBlink, eNone, 1500, True, ""
            Light054.State = 0
            Light053.State = 0
            Light057.State = 2
        Case 8:
            If LastSwitchHit = "bruja_target" Then
                DMD "_", CL(1, "CAPTURED 2 TITANS"), "", eNone, eBlink, eNone, 1500, True, ""
                Light057.State = 0
                DMD "_", "LOCK ON TO THE BEAST", "", eNone, eBlink, eNone, 1500, True, ""
                FolkTimer.Enabled = 1
            Else
                FolkCount = FolkCount -1
                Light054.State = 2
                ...
                Light057.State = 0
            End If
        Case 9:DMD "_", CL(1, "SHOOT BEAST TARGET"), "", eNone, eBlink, eNone, 1500, True, ""
            FolkTimer.Enabled = 0
            For X = 0 to 7
                aLightArrows(x).State = 0
            Next
            Light057.State = 2
        Case 10:DMD "_", " DEFEATED BEAST TITAN", "", eNone, eBlink, eNone, 1500, False, ""
            DMD "_", "ATTACK TITAN WINS", "", eNone, eBlink, eNone, 1500, True, ""
            StopFoltergeist
            ResetBRUJALetter
            StartBRUJALetter
    End Select
...
Sub StartIlussiaMUltiball
    StopBRUJALetter
    DMD "", "", "ilussia", eNone, eNone, eBlink, 1500, True, "vo_multiball2"
    AddMultiball 1
    post001.IsDropped = 0:PlaySoundAt "fx_SolenoidOn", Trigger010
    post002.IsDropped = 0
    vpmtimer.addtimer 2500, "PlaySoundAt""fx_SolenoidOff"", Trigger010: post001.IsDropped = 1:post002.IsDropped = 1 '"
...
Sub CheckLockedBalls 'updates also the lights
    Select Case BallsLocked(CurrentPlayer)
        ...
        Case 1:light007.State = 1:light006.State = 0:light070.State = 0
            LightEffect 1
            DMD CL(0, "BASEMENT"), CL(1, "BALL 1 LOCKED"), "", eNone, eBlink, eNone, 1500, True, "vo_ball1locked"
            vpmtimer.addtimer 2500, "Exit_WitchNest '"
        Case 2:light007.State = 1:light006.State = 1:light070.State = 0
            LightEffect 1
            DMD CL(0, "BASEMENT"), CL(1, "BALL 2 LOCKED"), "", eNone, eBlink, eNone, 1500, True, "vo_ball2locked"
            vpmtimer.addtimer 2500, "Exit_WitchNest '"
        Case 3:
            If Mode(CurrentPlayer, 0) = 10 Then
                DMD CL(0, "BASEMENT"), CL(1, "BALL 3 LOCKED"), "", eNone, eBlink, eNone, 1500, True, "vo_ball3locked"
                light007.State = 2:light006.State = 2:light070.State = 2
                LightEffect 1
                light058.State = 2
                bLockActive(CurrentPlayer) = False
                bLockActive(CurrentPlayer) = False
                DMD CL(0, "BASEMENT"), CL(1, "MULTIBALL IS READY"), "", eNone, eBlink, eNone, 5000, True, ""
...
Sub StartWitchMultiball
    ...
    ' flash show
    DMD CL(0, "BASEMENT"), CL(1, "MULTIBALL"), "", eNone, eBlink, eNone, 1500, True, "vo_multiball3"
    Exit_WitchNest
    post001.IsDropped = 0:PlaySoundAt "fx_SolenoidOn", Trigger010
    post002.IsDropped = 0
...
Sub AwardMystery
    ...
    Light046.State = 0
    LightEffect 1
    DMD "", "", "mystery", eNone, eNone, eBlink, 1500, True, "vo_mystery"
    tmp = INT(RND * 7 + MysteryLevel(CurrentPlayer)) * 150000
    DMD CL(0, "MIKASA BONUS"), CL(1, FormatScore(tmp)), "", eNone, eBlink, eNone, 1500, True, ""
    Addscore tmp
...
Sub AwardSPJackpot
    If bSPJActivated Then
        ...
        DMD CL(0, FormatScore(tmp)), "SUPER SCOUT JACKPOT", "", eNone, eBlinkFast, eNone, 1500, True, "vo_superjackpot2"
        DOF 126, DOFPulse
        Addscore tmp
        LightEffect 2
        StopSuperPyramid
...
Sub EnableFinisterra
    DMD "HITTING BEAST STARTS", "SCOUT MULTIBALL", "", eBlink, eBlink, eNone, 1500, True, ""
...
Sub StartFinisterra
    StopBRUJALetter
    DMD CL(0, "SCOUT"), "     MULTIBALL", "", eNone, eBlink, eNone, 1500, True, "vo_multiball"
    light045.State = 0
    light024.State = 0
    light025.State = 0
    light026.State = 0
...
Sub AwardFinisterraSJP
    ...
    DMD CL(0, FormatScore(tmp)), "SCOUT SJACKPOT", "", eNone, eBlinkFast, eNone, 1500, True, "vo_superjackpot"
    bFinisterraSJPActivated = False
    light045.State = 0
    light024.State = 0
    light025.State = 0
...
Sub AwardTombTreasure
    ...
    Select Case TombTreasureCount
        Case 0:
            DMD CL(0, "DISCOVERED"), CL(1, "15 MILLION"), "", eNone, eBlink, eNone, 1500, True, ""
            Addscore 15000000
        Case 1:
            DMD CL(0, "DISCOVERED"), CL(1, "SUPER SLINGSHOTS"), "", eNone, eBlink, eNone, 1500, True, ""
            SlingshotValue = 250000
        Case 2:
            DMD CL(0, "DISCOVERED"), CL(1, "+15MILL SCOUT SPJ"), "", eNone, eBlink, eNone, 1500, True, ""
            SuperPyramidValue = SuperPyramidValue + 15000000
            StartFelizNavidadCabrones
        Case 3:
            DMD CL(0, "DISCOVERED"), CL(1, "SUPER 5X COMBO"), "", eNone, eBlink, eNone, 1500, True, ""
            bSuperCombo = True
        Case 4:
            DMD CL(0, "DISCOVERED"), CL(1, "EXTRA BALL IS LIT"), "", eNone, eBlink, eNone, 1500, True, ""
            Light047.State = 1
        Case 5:
            DMD CL(0, "DISCOVERED"), CL(1, "BALL SAVE 60 SEC"), "", eNone, eBlink, eNone, 1500, True, ""
            EnableBallSaver 60
        Case 6:
            DMD CL(0, "DISCOVERED"), CL(1, "COLLECT 2X BONUS"), "", eNone, eBlink, eNone, 1500, True, ""
            BonusMultiplier(CurrentPlayer) = BonusMultiplier(CurrentPlayer) + 2
        Case 7:
            DMD CL(0, "DISCOVERED"), CL(1, "SUPER SCOUT 5X SPJ"), "", eNone, eBlink, eNone, 1500, True, ""
            SuperPyramidMultiplier = SuperPyramidMultiplier + 5
        Case 8:
            DMD CL(0, "DISCOVERED"), CL(1, "50 MILLION"), "", eNone, eBlink, eNone, 1500, True, ""
            Addscore 50000000
        Case 9:
            DMD CL(0, "DISCOVERED"), CL(1, "EXTRA BALL IS LIT"), "", eNone, eBlink, eNone, 1500, True, ""
    ...
    Select Case FNCStep
        ...
        Case 5                                                                                                                                                                   'all 7 lights
            If light056.State = 1 AND light053.State = 1 AND light055.State = 1 AND light052.State = 1 AND light054.State = 1 AND light049.State = 1 AND light057.State = 1 Then 'all 7 lights are green
                ...
                DMD "LEVI SQUAD", CL(1, "COMPLETED"), "", eNone, eBlink, eNone, 1500, True, ""
                Addscore 10000000
                StopFNC
                StartBRUJALetter
            End If
