...
Sub GameTimer_Timer()
	...
	DoSTAnim
	DoDTAnim
	Pincab_Rose_Rod.Y = -65 + (5* PlungerRose.Position) -20
	Pincab_Rose_Rose.Y = -65 + (5* PlungerRose.Position) -20
End Sub
...
Const Opt_Cabinet = 6 ' Only when not in VR
Const Opt_VR_Room = 6 ' Only when in VR
Const Opt_BackMod = 7
Const Opt_BladeMod = 8
