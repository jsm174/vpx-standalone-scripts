...
Sub EndOfBall()
    ...
    If NOT Tilted Then
        ...
        DMD "bonus-background.gif", "BRATS KILLED", monsters(CurrentPlayer), 700
...
Sub AwardSkillshot()
    ...
    Select case SkillShotValue(CurrentPlayer)
        case 1000000
            ...
            DMD "skillshot1.gif", " ", " ", 20000
            AddScore SkillshotValue(CurrentPLayer)
        case 2000000
            cellarlight.State = 2
            PlaySound "FreddysHome"
            DMD "skillshot2.gif", " ", " ", 20000
            AddScore SkillshotValue(CurrentPLayer)
        case 3000000
            cellarlight.State = 2
            PlaySound "FreddysHome"
            DMD "skillshot3.gif", " ", " ", 20000
            AddScore SkillshotValue(CurrentPLayer)
        case 4000000
            cellarlight.State = 2
            PlaySound "FreddysHome"
            DMD "skillshot4.gif", " ", " ", 20000
            AddScore SkillshotValue(CurrentPLayer)
        case 5000000
            cellarlight.State = 2
            PlaySound "FreddysHome"
            DMD "skillshot5.gif", " ", " ", 20000
            AddScore SkillshotValue(CurrentPLayer)
        case ELSE
            cellarlight.State = 2
            PlaySound "FreddysHome"
...
Sub EightBitSuperJackpotTimer_Timer 'in timer options look at the interval, its 2500 2 1/2 seconds
    ...
    DMDFlush
    DMD "EightBitSuperJackpot.gif", " ", "         ", 6500
...
Sub SixteenBitBonusWaveVideo_Timer 'in timer options look at the interval, its 2500 2 1/2 seconds
    ...
    DMDFlush
    DMD "SixteenBitTimer.gif", "", "", 420000
