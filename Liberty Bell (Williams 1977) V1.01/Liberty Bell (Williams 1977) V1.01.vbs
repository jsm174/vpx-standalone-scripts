...
Function Vol(ball) ' Calculates the Volume of the sound based on the ball speed
    Vol = Csng(BallVel(ball) ^2 / 2000) + 0   ' Add some value here or subtract some value if the rolling is too soft or too loud
End Function
