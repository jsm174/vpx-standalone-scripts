' ******************************************************************
'       VPX - version by Klodo81 2022, HONEY version 1.2
'
'       Table built from JPSalas Williams Big Star Version 4.0.0
'
...
Sub KickerC_Hit
	...
	vpmtimer.addtimer delay, "PlaySoundAt SoundFXDOF (""fx_kicker"", 114, DOFPulse, DOFContactors), kickerC : kickerC.kick 190, 15 '"
	If Bl1k.State = 0 Then vpmtimer.addtimer delay + 250, "ResetTargetC '"
...
Sub KickerL_Hit
	...
	vpmtimer.addtimer delay, "PlaySoundAt SoundFXDOF (""fx_kicker"", 132, DOFPulse, DOFContactors), kickerL : kickerL.kick 120, 20 '"
End Sub
...
Sub KickerR_Hit
	...
	vpmtimer.addtimer delay, "PlaySoundAt SoundFXDOF (""fx_kicker"", 133, DOFPulse, DOFContactors), kickerR : kickerR.kick 230, 20 '"
End Sub
