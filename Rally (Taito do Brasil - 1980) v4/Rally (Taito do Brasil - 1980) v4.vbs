...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Rally - Taito 1980" & vbNewLine & "VPX table by JPSalas v.4.0.0"
        .HandleKeyboard = 0
        .ShowTitle = 0
        .ShowDMDOnly = 1
        .ShowFrame = 0
...
Sub sw74a_Hit:vpmTimer.PulseSw 74:End Sub
...
' Bumpers
Sub Bumper1_Hit:vpmTimer.PulseSw 71:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper1:Bumper1L.Duration 1, 500, 0:Bumper1La.Duration 1, 500, 0:End Sub
Sub Bumper2_Hit:vpmTimer.PulseSw 72:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper2:Bumper2L.Duration 1, 500, 0:Bumper2La.Duration 1, 500, 0:End Sub
Sub Bumper3_Hit:vpmTimer.PulseSw 73:PlaySoundAt SoundFX("fx_bumper", DOFContactors), Bumper3:Bumper3L.Duration 1, 500, 0:Bumper3La.Duration 1, 500, 0:End Sub

' Drain hole
Sub Drain_Hit:PlaysoundAt "fx_drain", Drain:bsTrough.AddBall Me:End Sub

' Saucer
Sub sw2_Hit():bsSaucer.AddBall 0:PlaysoundAt "fx_kicker_enter", sw2:End Sub
...
Sub sw41_Hit:Controller.Switch(41) = 1:PlaySoundAt "fx_sensor", sw41:sw41l.Duration 2, 1000, 1:End Sub
Sub sw41_UnHit:Controller.Switch(41) = 0:End Sub

Sub sw51_Hit:Controller.Switch(51) = 1:PlaySoundAt "fx_sensor", sw51:sw51l.Duration 2, 1000, 1:End Sub
Sub sw51_UnHit:Controller.Switch(51) = 0:End Sub

'Spinners
Sub sw61_Spin():vpmTimer.PulseSw 61:PlaySoundAt "fx_spinner", sw61:End Sub
