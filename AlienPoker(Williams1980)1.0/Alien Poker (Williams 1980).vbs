...
CustomWalls = 0 'set to 0 for Modern Minimal Walls, floor, and roof, 1 for Sixtoe's original walls and floor
...
Const cGameName="alpok_l6",UseSolenoids=2,UseLamps=0,UseGI=0,SSolenoidOn="Solenoid",SSolenoidOff="SolOff"
Const SCoin=""
...
SolCallback(2)	= "SolSpade"
SolCallback(3)	= "SolHeart"
SolCallback(4)	= "dt10drop"
SolCallback(5)	= "dtJdrop"
SolCallback(6)	= "dtQdrop"
SolCallback(7)	= "dtKdrop"
SolCallback(8)	= "dtAdrop"
SolCallback(14)	= "SolKnocker"
SolCallback(15)	= "SolClub"
SolCallback(16)	=  "vpmNudge.SolGameOn"
SolCallback(21)	=  "SolDropUp"
...
Sub SolDropUp(enabled)
	if enabled then
		PlaySoundAt SoundFX(DTDropSound,DOFContactors), psw26
		DTDrop 42
		DTDrop 34
		DTDrop 26
		DTDrop 18
...
'	On Error Resume Next
	With Controller
		...
		.SplashInfoLine = "Alien Poker (Williams 1980)"
		.HandleMechanics=0
		.HandleKeyboard=0
		.ShowDMDOnly=1
		.ShowFrame=0
...
'	vpmNudge.TiltObj = Array(Bumper001,Bumper002,Bumper003,Bumper004,LeftSlingshot)
	...
	setup_backglass()  ' for Backglass in VR 
...
Sub Table1_KeyDown(ByVal KeyCode)
	...
	If keycode = RightFlipperKey Then FlipperActivate RightFlipper, RFPress : Controller.Switch(43) = 1
	...
	If keycode = StartGameKey Then
        VR_StartButton.y = VR_StartButton.y - 8 
        End If
...
Sub Table1_KeyUp(ByVal KeyCode)
	...
	If keycode = RightFlipperKey Then FlipperDeActivate RightFlipper, RFPress : Controller.Switch(43) = 0
...
'Stand Up Targets
 ...
 Sub Tsw16_Hit: PrimStandupTgtHit 16, Tsw16, PrimT16: vpmTimer.PulseSw 16 : End Sub
 Sub Tsw16_Timer: PrimStandupTgtMove 16, Tsw16, PrimT16: End Sub
 ...
 Sub Tsw30_Hit: PrimStandupTgtHit 30, Tsw30, PrimT30: vpmTimer.PulseSw 30 : End Sub
 Sub Tsw30_Timer: PrimStandupTgtMove 30, Tsw30, PrimT30: End Sub
...
Sub Bumper002_Hit
	...
	bumper002timer.enabled=1
End Sub
 
sub bumper002timer_timer
	layer1skirt2.rotx=0
	layer1skirt2.roty=0
	me.enabled=0
end sub
...
Sub Bumper003_Hit
	...
	bumper003timer.enabled=1
End Sub
 
sub bumper003timer_timer
	layer1skirt3.rotx=0
	layer1skirt3.roty=0
	me.enabled=0
end sub
...
Sub Bumper004_Hit
	vpmTimer.PulseSw 38
	RandomSoundBumperMiddle Bumper004
	layer1skirt4.roty=skirtAY(me,Activeball)
	layer1skirt4.rotx=skirtAX(me,Activeball)
	bumper004timer.enabled=1
End Sub
 
sub bumper004timer_timer
	layer1skirt4.rotx=0
	layer1skirt4.roty=0
	me.enabled=0
end sub
...
dim kickstep1, kickstep2, kickstep3
...
Sub SolSpade(Enable)
    If Enable then
		PlaySoundAt SoundFX("Saucer_Kick", DOFCOntactors) , sw15
		kickstep1 = 0
		pkickarm002.rotz=15
		If sw15.ballcntover > 0 then
			KickBall KickerBall, 170, 16, 5, 30
		End If
		sw15.timerenabled = 1 
    End If
End Sub
...
Sub sw15_timer
        ...
        Case 3:pkickarm002.rotz=15
        Case 4:pkickarm002.rotz=15
        Case 5:pkickarm002.rotz=15
        Case 6:pkickarm002.rotz=15
        Case 7:pkickarm002.rotz=8
        Case 8:pkickarm002.rotz=3
		Case 9:pkickarm002.rotz=0:sw15.TimerEnabled = 0: if sw15.ballcntover > 0 then SolSpade -1
    End Select
...
Sub SolHeart(Enable)
    If Enable then
		...
		kickstep2 = 0
		pkickarm001.rotz=15
		If sw29.ballcntover > 0 then
			KickBall KickerBall, 190, 16, 5, 30
		End If
		sw29.timerenabled = 1 
    End If
End Sub
...
Sub sw29_timer
		...
		Case 9:pkickarm001.rotz=0:sw29.TimerEnabled = 0: if sw29.ballcntover > 0 then SolHeart -1
    End Select
...
Sub SolClub(Enable)
    If Enable then
		PlaySoundAt SoundFX("Saucer_Kick", DOFCOntactors), sw22
		kickstep3 = 0
		pkickarm003.rotz=15
		If sw22.ballcntover > 0 then
			KickBall KickerBall, 90, 16, 5, 30
		End If
		sw22.timerenabled = 1 
    End If
End Sub
...
Sub sw22_timer
		Select Case kickstep3
        Case 3:pkickarm003.rotz=15
        Case 4:pkickarm003.rotz=15
        Case 5:pkickarm003.rotz=15
        Case 6:pkickarm003.rotz=15
        Case 7:pkickarm003.rotz=8
        Case 8:pkickarm003.rotz=3
		Case 9:pkickarm003.rotz=0:sw22.TimerEnabled = 0: if sw22.ballcntover > 0 then SolClub -1
    End Select
   kickstep3 = kickstep3 + 1
End Sub

'Leaf switches
Sub phys_sw19_Hit : vpmTimer.PulseSw 19 : End Sub
Sub phys_sw21_Hit : vpmTimer.PulseSw 21 : End Sub
Sub phys_sw28_Hit : vpmTimer.PulseSw 28 : End Sub 
Sub phys_sw33_Hit : vpmTimer.PulseSw 33 : End Sub
Sub phys_sw39_Hit : vpmTimer.PulseSw 39 : End Sub
Sub phys_sw40_Hit : vpmTimer.PulseSw 40 : End Sub
Sub phys_sw41_Hit : vpmTimer.PulseSw 41 : End Sub
 ...
 Sub sw12_Hit  : Controller.Switch(12) = 1 : wire2.transz=-6:End Sub
 Sub sw12_UnHit: Controller.Switch(12) = 0 : wire2.transz=0:End Sub
 Sub sw23_Hit  : Controller.Switch(23) = 1 : wire4.transz=-6:End Sub
 Sub sw23_UnHit: Controller.Switch(23) = 0 : wire4.transz=0:End Sub
 Sub sw24_Hit  : Controller.Switch(24) = 1 : wire5.transz=-6:End Sub
 Sub sw24_UnHit: Controller.Switch(24) = 0 : wire5.transz=0:End Sub
 Sub sw25_Hit  : Controller.Switch(25) = 1 : wire6.transz=-6:End Sub
 Sub sw25_UnHit: Controller.Switch(25) = 0 : wire6.transz=0:End Sub
 Sub sw27_Hit  : Controller.Switch(27) = 1 : wire7.transz=-6:End Sub
 Sub sw27_UnHit: Controller.Switch(27) = 0 : wire7.transz=0:End Sub
 Sub sw33_Hit  : Controller.Switch(33) = 1 : wire3.transz=-6:End Sub
 Sub sw33_UnHit: Controller.Switch(33) = 0 : wire3.transz=0:End Sub

'Spinner
Sub sw17_Spin : vpmTimer.PulseSw (17) :PlaySoundAtLevelStatic ("fx_spinner"), gatesoundlevel, spinnerrod: End Sub

'***********Rotate Spinner
Dim Angle

Sub SpinnerTimer_Timer
'	Spinmesh.Rotx = sw17.CurrentAngle
'	Angle = (sin (sw17.CurrentAngle-180))
	SpinnerRod.TransX = sin( (sw17.CurrentAngle+180) * (2*PI/360)) * 12
	SpinnerRod.TransZ = sin( (sw17.CurrentAngle- 90) * (2*PI/360)) * 3.5
...
NFadeLm 25, L25
NFadeLm 26, L26
NFadeObjm 27, plastics, "layer2_ace", "layer2"
NFadeLm 28, L28
NFadeLm 29, L29
NFadeObjm 29, bumpers1, "layer1_bumpson", "layer1"
NFadeObjm 29, layer1skirt1, "layer1_bumpson", "layer1"
NFadeLm 30, L30
NFadeObjm 30, bumpers2, "layer1_bumpson", "layer1"
NFadeObjm 30, layer1skirt2, "layer1_bumpson", "layer1"
NFadeLm 31, L31
NFadeObjm 31, bumpers4, "layer1_bumpson", "layer1"
NFadeObjm 31, layer1skirt4, "layer1_bumpson", "layer1"
NFadeLm 32, L32
NFadeObjm 32, bumpers3, "layer1_bumpson", "layer1"
NFadeObjm 32, layer1skirt3, "layer1_bumpson", "layer1"
NFadeLm 33, L33
NFadeLm 34, L34
NFadeLm 35, L35
NFadeLm 36, L36
...
if flippershadows=1 then
	...
	batrightshadow001.visible=1
else
	batleftshadow.visible=0
	batrightshadow.visible=0
	batrightshadow001.visible=0
end if
...
Sub FrameTimer_Timer()
	...
	If VR_Room=1 Then BG_DisplayTimer  ' For Backglass in VR
	If VR_Room=1 Then UpdateMultipleLamps ' For Backglass animation in VR
End Sub
...
Dim DTArray
DTArray = Array(DT10, DT18, DT26, DT34, DT42)

'Configure the behavior of Drop Targets.
Const DTDropSpeed = 110 			'in milliseconds
Const DTDropUpSpeed = 30 			'in milliseconds
Const DTDropUnits = 45				'VP units primitive drops
Const DTDropUpUnits = 2 			'VP units primitive raises above the up position on drops up
Const DTMaxBend = 8 				'max degrees primitive rotates when hit
Const DTDropDelay = 23	 		'time in milliseconds before target drops (due to friction/impact of the ball)
Const DTRaiseDelay = 30	 		'time in milliseconds before target drops back to normal up position after the solendoid fires to raise the target
...
Const DTResetSound = "DTDrop"	'Drop Target reset sound
...
Sub DoDTAnim()
	...
	DTShadow psw34, shsw34
	DTShadow psw26, shsw26
	DTShadow psw18, shsw18
	DTShadow psw10, shsw10
End Sub
...
Sub setup_backglass()
	...
	xoff = -20 '-20
	yoff1 = 23 'player1 score depth
	yoff2 = 23 'player2 score depth
	yoff3 = 31  'player3 score depth
	yoff4 = 38 'player4 score depth
	yoff5 = 42 'credit and ball depth
	zoff = 694 '699
	xrot = -90 '-90
...
Sub UpdateMultipleLamps()
	...
	If Controller.Lamp(63) = 0 Then: fshootagain.visible=0: else: fshootagain.visible=1 	'Same Player Shoots Again
	If Controller.Lamp(64) = 0 Then: fhighestscore.visible=0: else: fhighestscore.visible=1 'High Score

	If Controller.Lamp(50) = 0 Then: f1player.visible=0: else: f1player.visible=1 			'One Player
	If Controller.Lamp(51) = 0 Then: f2player.visible=0: else: f2player.visible=1 			'Two Players
	If Controller.Lamp(52) = 0 Then: f3player.visible=0: else: f3player.visible=1 			'Three Players
	If Controller.Lamp(53) = 0 Then: f4player.visible=0: else: f4player.visible=1 			'Four Players

	If Controller.Lamp(57) = 0 Then: fp1up.visible=0: else: fp1up.visible=1 				'P1
	If Controller.Lamp(58) = 0 Then: fp2up.visible=0: else: fp2up.visible=1 				'P2
	If Controller.Lamp(59) = 0 Then: fp3up.visible=0: else: fp3up.visible=1 				'P3
	If Controller.Lamp(60) = 0 Then: fp4up.visible=0: else: fp4up.visible=1 				'P4
End Sub
