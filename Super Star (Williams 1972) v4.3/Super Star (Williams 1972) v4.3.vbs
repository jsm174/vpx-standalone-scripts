...
'        Super Star / IPD No. 2446 / August 21, 1972 / 1 Player
'                        Version 4.3.0
' ****************************************************************
...
' Valores Constants
Const TableName = "superstar" ' se usa para cargar y grabar los highscore y creditos
Const cGameName = "superstar" ' para el B2S
Const MaxPlayers = 1          ' de 1 a 4
Const MaxMultiplier = 1       ' limita el bonus multiplicador
Const BallsPerGame = 5        ' normalmente 3 ó 5
Const BlueTargetValue = 1     ' Number of bonus: 1 for 5 ball, 2,3 or 4 for 3 ball
Const LibertyMode = False     ' if True SU and ER lights er linked totgether, best for 3 ball game
Const Special1 = 45000        ' puntuación a obtener para partida extra
Const Special2 = 65000        ' puntuación a obtener para partida extra
Const Special3 = 85000        ' puntuación a obtener para partida extra
Const Special4 = 99000        ' puntuación a obtener para partida extra
