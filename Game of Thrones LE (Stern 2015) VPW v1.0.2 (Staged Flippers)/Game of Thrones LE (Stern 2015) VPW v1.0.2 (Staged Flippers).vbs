...
Sub Table1_KeyDown(ByVal Keycode)
    ...
    If bGameInPlay AND NOT Tilted Then
        ...
        If keycode = LeftFlipperKey Then 
            If WHCFlipperFrozen = False Then
...
Sub SolULFlipper(Enabled)
    If Enabled Then
        ULF.Fire
        If LeftUFlipper.currentangle < LeftUFlipper.endangle + ReflipAngle Then 
    ...
    Else
       LeftUFlipper.RotateToStart
		If LeftUFlipper.currentangle < LeftUFlipper.startAngle - 5 Then
...
Sub SolURFlipper(Enabled)
    If Enabled Then
        URF.Fire
        If RightUFlipper.currentangle > RightUFlipper.endangle - ReflipAngle Then 
    ...
    Else
        ...
        If RightUFlipper.currentangle > RightUFlipper.startAngle + 5 Then
...
Sub CheckQuickRestartFinished
    if BallsOnPlayfield = 0 Then DisableTable False : GiOff : Exit Sub
    vpmTimer.AddTimer 1000,"CheckQuickRestartFinished '"
End Sub
...
' TODO:
' - adjust font size of primary player as soon as score crosses 1bil.
