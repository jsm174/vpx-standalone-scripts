...
Const enableEyeColors	= False
Const enableRampColors	= False
...
Sub Game_Init
	...
	PlaySoundAt SoundFXDOF("DTReset", 120, DOFPulse, DOFDropTargets), Target10
	tchr = 34
	modetime = 0
	keysearch = 0
	freezersound = true
...
'		organpart004.blenddisablelighting=0.4+ObjLevel(3)+ObjLevel(4)
	...
	FadeL 128 : Goonie001.blenddisablelighting=0.1+i/15
				...
				Select case i
					case 0 : sidewalls.image = "cabinsidegoonies_off" : backwall.image  = "cabinsidegoonies_off"
					case 2 : sidewalls.image = "cabinsidegoonies3"    : backwall.image  = "cabinsidegoonies3"
					case 4 : sidewalls.image = "cabinsidegoonies2"    : backwall.image  = "cabinsidegoonies2"
					case 6 : sidewalls.image = "cabinsidegoonies"     : backwall.image  = "cabinsidegoonies"
				End Select
